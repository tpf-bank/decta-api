...
// ClientId is a unique client id number generated on the DECTA partner side. Length 18 symbols
...
*/
func (a *AccountsAPIService) GetTransactionsQueueInfo(ctx context.Context, cardAccount string) ApiGetTransactionsQueueInfoRequest {
	return ApiGetTransactionsQueueInfoRequest{
		ApiService:  a,
		ctx:         ctx,
...
//
//	@return DataArray
func (a *AccountsAPIService) GetTransactionsQueueInfoExecute(r ApiGetTransactionsQueueInfoRequest) (*DataArray, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountsAPIService.GetTransactionsQueueInfo")
	if err != nil {
