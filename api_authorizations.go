...
*/
func (a *AuthorizationsAPIService) GetHoldsList(ctx context.Context, ppan string) ApiGetHoldsListRequest {
	return ApiGetHoldsListRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
func (a *AuthorizationsAPIService) GetHoldsListExecute(r ApiGetHoldsListRequest) (*HoldsDataArray, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthorizationsAPIService.GetHoldsList")
	if err != nil {
