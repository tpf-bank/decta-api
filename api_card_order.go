...
type ApiGetOrdersListRequest struct {
	ctx            context.Context
	ApiService     *CardOrderAPIService
	tokenHeader    *string
...
<ul><h3>Order status possible values:</h3>    <li>Registered – a card order is registered in the system and awaiting the launch of the manual card issue process</li>
	...
	<li>Duplicated found – a card order is registered but duplicate orders have been identified</li>
	<li>External check failed – an external person validity check has failed</li>
...
*/
func (a *CardOrderAPIService) GetOrdersList(ctx context.Context) ApiGetOrdersListRequest {
	return ApiGetOrdersListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []Order
func (a *CardOrderAPIService) GetOrdersListExecute(r ApiGetOrdersListRequest) ([]Order, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CardOrderAPIService.GetOrdersList")
	if err != nil {
...
*/
func (a *CardOrderAPIService) OrderCard(ctx context.Context) ApiOrderCardRequest {
	return ApiOrderCardRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CardOrderAPIService) OrderCardExecute(r ApiOrderCardRequest) (*OrderCardResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CardOrderAPIService.OrderCard")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CardOrderAPIService) OrderGiftCard(ctx context.Context) ApiOrderGiftCardRequest {
	return ApiOrderGiftCardRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CardOrderAPIService) OrderGiftCardExecute(r ApiOrderGiftCardRequest) (*GiftOrderCardResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CardOrderAPIService.OrderGiftCard")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
