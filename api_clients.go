...
*/
func (a *ClientsAPIService) ChangeDeliveryAddress(ctx context.Context, ppan string) ApiChangeDeliveryAddressRequest {
	return ApiChangeDeliveryAddressRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
func (a *ClientsAPIService) ChangeDeliveryAddressExecute(r ApiChangeDeliveryAddressRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientsAPIService.ChangeDeliveryAddress")
	if err != nil {
...
The request allows users to receive clients data by using specific client id number
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clientId clientId is a unique client id number generated on the DECTA partner side. Length 18 symbols
	@return ApiGetClientRequest
*/
func (a *ClientsAPIService) GetClient(ctx context.Context, clientId string) ApiGetClientRequest {
	return ApiGetClientRequest{
		ApiService: a,
		ctx:        ctx,
		clientId:   clientId,
...
//
//	@return ClientInfo
func (a *ClientsAPIService) GetClientExecute(r ApiGetClientRequest) (*ClientInfo, *http.Response, error) {
	var (
...
func (a *ClientsAPIService) GetClientsExecute(r ApiGetClientsRequest) (*ClientInfoDataArray, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
*/
func (a *ClientsAPIService) UpdateClientAddress(ctx context.Context, clientId string) ApiUpdateClientAddressRequest {
	return ApiUpdateClientAddressRequest{
		ApiService: a,
		ctx:        ctx,
		clientId:   clientId,
...
// Execute executes the request
func (a *ClientsAPIService) UpdateClientAddressExecute(r ApiUpdateClientAddressRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPatch
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientsAPIService.UpdateClientAddress")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ClientsAPIService) UpdatePassphrase(ctx context.Context, ppan string) ApiUpdatePassphraseRequest {
	return ApiUpdatePassphraseRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
// Execute executes the request
func (a *ClientsAPIService) UpdatePassphraseExecute(r ApiUpdatePassphraseRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientsAPIService.UpdatePassphrase")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
The request allows users to update clients mobile phone number.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param clientId clientId is a unique client \"id\" number generated on Decta partner side. Length 18 symbols
	@return ApiUpdatePhoneRequest
*/
func (a *ClientsAPIService) UpdatePhone(ctx context.Context, clientId string) ApiUpdatePhoneRequest {
	return ApiUpdatePhoneRequest{
		ApiService: a,
		ctx:        ctx,
		clientId:   clientId,
...
// Execute executes the request
func (a *ClientsAPIService) UpdatePhoneExecute(r ApiUpdatePhoneRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPut
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClientsAPIService.UpdatePhone")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
