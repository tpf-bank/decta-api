...
*/
func (a *LimitsAPIService) EditLimits(ctx context.Context, ppan string) ApiEditLimitsRequest {
	return ApiEditLimitsRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
func (a *LimitsAPIService) EditLimitsExecute(r ApiEditLimitsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LimitsAPIService.EditLimits")
	if err != nil {
...
*/
func (a *LimitsAPIService) GetLimits(ctx context.Context, ppan string) ApiGetLimitsRequest {
	return ApiGetLimitsRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
//
//	@return LimitsData
func (a *LimitsAPIService) GetLimitsExecute(r ApiGetLimitsRequest) (*LimitsData, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LimitsAPIService.GetLimits")
	if err != nil {
...
*/
func (a *LimitsAPIService) GetLimitsRefData(ctx context.Context) ApiGetLimitsRefDataRequest {
	return ApiGetLimitsRefDataRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return LimitsData
func (a *LimitsAPIService) GetLimitsRefDataExecute(r ApiGetLimitsRefDataRequest) (*LimitsData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LimitsAPIService.GetLimitsRefData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
