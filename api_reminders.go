...
*/
func (a *RemindersAPIService) GetPinTryCounter(ctx context.Context, ppan string) ApiGetPinTryCounterRequest {
	return ApiGetPinTryCounterRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
func (a *RemindersAPIService) GetPinTryCounterExecute(r ApiGetPinTryCounterRequest) (*PinTryCounterInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RemindersAPIService.GetPinTryCounter")
	if err != nil {
...
*/
func (a *RemindersAPIService) RemindPanCvv(ctx context.Context, ppan string) ApiRemindPanCvvRequest {
	return ApiRemindPanCvvRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
// Execute executes the request
func (a *RemindersAPIService) RemindPanCvvExecute(r ApiRemindPanCvvRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RemindersAPIService.RemindPanCvv")
	if err != nil {
...
*/
func (a *RemindersAPIService) RemindPin(ctx context.Context, ppan string) ApiRemindPinRequest {
	return ApiRemindPinRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
// Execute executes the request
func (a *RemindersAPIService) RemindPinExecute(r ApiRemindPinRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RemindersAPIService.RemindPin")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *RemindersAPIService) ResetPinTryCounter(ctx context.Context, ppan string) ApiResetPinTryCounterRequest {
	return ApiResetPinTryCounterRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
// Execute executes the request
func (a *RemindersAPIService) ResetPinTryCounterExecute(r ApiResetPinTryCounterRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RemindersAPIService.ResetPinTryCounter")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
