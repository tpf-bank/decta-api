...
type ApiChangeTokenStatusRequest struct {
	ctx               context.Context
	ApiService        *TokenAPIService
	tokenNumber       string
	tokenHeader       *string
	tokenSignature    *string
	tokenStatusChange *TokenStatusChange
	requestId         *string
}

// URL64Encoded without padding Header part of JWS token
func (r ApiChangeTokenStatusRequest) TokenHeader(tokenHeader string) ApiChangeTokenStatusRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiChangeTokenStatusRequest) TokenSignature(tokenSignature string) ApiChangeTokenStatusRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiChangeTokenStatusRequest) TokenStatusChange(tokenStatusChange TokenStatusChange) ApiChangeTokenStatusRequest {
	r.tokenStatusChange = &tokenStatusChange
	return r
}

// Request ID (UUID format)
func (r ApiChangeTokenStatusRequest) RequestId(requestId string) ApiChangeTokenStatusRequest {
	r.requestId = &requestId
	return r
}

func (r ApiChangeTokenStatusRequest) Execute() (*http.Response, error) {
	return r.ApiService.ChangeTokenStatusExecute(r)
}

/*
ChangeTokenStatus Change tokens status

The request allows users to change the status of the card token. Allowed token status values:
ACTIVE value can be used only to resume card while it is in status SUSPENDED;
SUSPENDED value can be used only while token is in status ACTIVE to temporary suspend token from usage;
DEACTIVATED value is equivalent to permanent token delete. May be used only on tokens with original status of ACTIVE or SUSPENDED. This status change can't be reversed.
Other available token statuses are not allowed to be used in this endpoint.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param tokenNumber masked card number
	@return ApiChangeTokenStatusRequest
*/
func (a *TokenAPIService) ChangeTokenStatus(ctx context.Context, tokenNumber string) ApiChangeTokenStatusRequest {
	return ApiChangeTokenStatusRequest{
		ApiService:  a,
		ctx:         ctx,
...
func (a *TokenAPIService) ChangeTokenStatusExecute(r ApiChangeTokenStatusRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TokenAPIService.ChangeTokenStatus")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/tokens/{tokenNumber}/state"
	localVarPath = strings.Replace(localVarPath, "{"+"tokenNumber"+"}", url.PathEscape(parameterValueToString(r.tokenNumber, "tokenNumber")), -1)
	...
	// body params
	localVarPostBody = r.tokenStatusChange
...
type ApiGetApplePayReferenceDataRequest struct {
	ctx            context.Context
	ApiService     *TokenAPIService
	ppan           string
	tokenHeader    *string
...
// URL64Encoded without padding Header part of JWS token
func (r ApiGetApplePayReferenceDataRequest) TokenHeader(tokenHeader string) ApiGetApplePayReferenceDataRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetApplePayReferenceDataRequest) TokenSignature(tokenSignature string) ApiGetApplePayReferenceDataRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// Request ID (UUID format)
func (r ApiGetApplePayReferenceDataRequest) RequestId(requestId string) ApiGetApplePayReferenceDataRequest {
	r.requestId = &requestId
	return r
}

func (r ApiGetApplePayReferenceDataRequest) Execute() (*PanReferenceData, *http.Response, error) {
	return r.ApiService.GetApplePayReferenceDataExecute(r)
}

/*
GetApplePayReferenceData Get ApplePay reference data

The request allows users to receive PAN reference data for specific card using ApplePay flow.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param ppan masked card number
	@return ApiGetApplePayReferenceDataRequest
*/
func (a *TokenAPIService) GetApplePayReferenceData(ctx context.Context, ppan string) ApiGetApplePayReferenceDataRequest {
	return ApiGetApplePayReferenceDataRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
// Execute executes the request
//
//	@return PanReferenceData
func (a *TokenAPIService) GetApplePayReferenceDataExecute(r ApiGetApplePayReferenceDataRequest) (*PanReferenceData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PanReferenceData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TokenAPIService.GetApplePayReferenceData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/tokens/{ppan}/applepay-reference-data"
...
type ApiGetGooglePayReferenceDataRequest struct {
	ctx            context.Context
	ApiService     *TokenAPIService
	ppan           string
	tokenHeader    *string
...
// URL64Encoded without padding Header part of JWS token
func (r ApiGetGooglePayReferenceDataRequest) TokenHeader(tokenHeader string) ApiGetGooglePayReferenceDataRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetGooglePayReferenceDataRequest) TokenSignature(tokenSignature string) ApiGetGooglePayReferenceDataRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// Request ID (UUID format)
func (r ApiGetGooglePayReferenceDataRequest) RequestId(requestId string) ApiGetGooglePayReferenceDataRequest {
	r.requestId = &requestId
	return r
}

func (r ApiGetGooglePayReferenceDataRequest) Execute() (*Data, *http.Response, error) {
	return r.ApiService.GetGooglePayReferenceDataExecute(r)
}

/*
GetGooglePayReferenceData Get GooglePay reference data

The request allows users to receive token reference data for specific card for all GooglePay tokens of 03 - “Host Card Emulation” type.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param ppan masked card number
	@return ApiGetGooglePayReferenceDataRequest
*/
func (a *TokenAPIService) GetGooglePayReferenceData(ctx context.Context, ppan string) ApiGetGooglePayReferenceDataRequest {
	return ApiGetGooglePayReferenceDataRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
//
//	@return Data
func (a *TokenAPIService) GetGooglePayReferenceDataExecute(r ApiGetGooglePayReferenceDataRequest) (*Data, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TokenAPIService.GetGooglePayReferenceData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/tokens/{ppan}/googlepay-reference-data"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
...
type ApiGetPanReferenceDataRequest struct {
	ctx            context.Context
	ApiService     *TokenAPIService
	ppan           string
	tokenHeader    *string
...
// URL64Encoded without padding Header part of JWS token
func (r ApiGetPanReferenceDataRequest) TokenHeader(tokenHeader string) ApiGetPanReferenceDataRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetPanReferenceDataRequest) TokenSignature(tokenSignature string) ApiGetPanReferenceDataRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// Request ID (UUID format)
func (r ApiGetPanReferenceDataRequest) RequestId(requestId string) ApiGetPanReferenceDataRequest {
	r.requestId = &requestId
	return r
}

func (r ApiGetPanReferenceDataRequest) Execute() (*PanReferenceData, *http.Response, error) {
	return r.ApiService.GetPanReferenceDataExecute(r)
}

/*
GetPanReferenceData Method for GetPanReferenceData

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param ppan masked card number
	@return ApiGetPanReferenceDataRequest
*/
func (a *TokenAPIService) GetPanReferenceData(ctx context.Context, ppan string) ApiGetPanReferenceDataRequest {
	return ApiGetPanReferenceDataRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
//
//	@return PanReferenceData
func (a *TokenAPIService) GetPanReferenceDataExecute(r ApiGetPanReferenceDataRequest) (*PanReferenceData, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TokenAPIService.GetPanReferenceData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/tokens/{ppan}/pan-reference-data"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
...
type ApiGetTokenReferenceDataRequest struct {
	ctx            context.Context
	ApiService     *TokenAPIService
	ppan           string
	tokenHeader    *string
...
// URL64Encoded without padding Header part of JWS token
func (r ApiGetTokenReferenceDataRequest) TokenHeader(tokenHeader string) ApiGetTokenReferenceDataRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetTokenReferenceDataRequest) TokenSignature(tokenSignature string) ApiGetTokenReferenceDataRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// Request ID (UUID format)
func (r ApiGetTokenReferenceDataRequest) RequestId(requestId string) ApiGetTokenReferenceDataRequest {
	r.requestId = &requestId
	return r
}

func (r ApiGetTokenReferenceDataRequest) Execute() (*Data, *http.Response, error) {
	return r.ApiService.GetTokenReferenceDataExecute(r)
}

/*
GetTokenReferenceData Method for GetTokenReferenceData

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param ppan masked card number
	@return ApiGetTokenReferenceDataRequest
*/
func (a *TokenAPIService) GetTokenReferenceData(ctx context.Context, ppan string) ApiGetTokenReferenceDataRequest {
	return ApiGetTokenReferenceDataRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
//
//	@return Data
func (a *TokenAPIService) GetTokenReferenceDataExecute(r ApiGetTokenReferenceDataRequest) (*Data, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TokenAPIService.GetTokenReferenceData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/tokens/{ppan}/token-reference-data"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
...
// URL64Encoded without padding Header part of JWS token
func (r ApiGetTokensRequest) TokenHeader(tokenHeader string) ApiGetTokensRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetTokensRequest) TokenSignature(tokenSignature string) ApiGetTokensRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// Request ID (UUID format)
func (r ApiGetTokensRequest) RequestId(requestId string) ApiGetTokensRequest {
	r.requestId = &requestId
	return r
}

func (r ApiGetTokensRequest) Execute() (*TokenInfo, *http.Response, error) {
	return r.ApiService.GetTokensExecute(r)
}

/*
GetTokens Get card token

The request allows users to receive all the tokens for the selected PPAN.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param ppan masked card number
	@return ApiGetTokensRequest
*/
func (a *TokenAPIService) GetTokens(ctx context.Context, ppan string) ApiGetTokensRequest {
	return ApiGetTokensRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
//
//	@return TokenInfo
func (a *TokenAPIService) GetTokensExecute(r ApiGetTokensRequest) (*TokenInfo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localVarPath := localBasePath + "/v1/api/tokens/{ppan}"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
