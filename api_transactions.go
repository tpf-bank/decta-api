...
*/
func (a *TransactionsAPIService) CardTransactions(ctx context.Context, ppan string) ApiCardTransactionsRequest {
	return ApiCardTransactionsRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
func (a *TransactionsAPIService) CardTransactionsExecute(r ApiCardTransactionsRequest) (*TransactionInfoDataArray, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionsAPIService.CardTransactions")
	if err != nil {
...
*/
func (a *TransactionsAPIService) DoTransaction(ctx context.Context, ppan string) ApiDoTransactionRequest {
	return ApiDoTransactionRequest{
		ApiService: a,
		ctx:        ctx,
		ppan:       ppan,
...
func (a *TransactionsAPIService) DoTransactionExecute(r ApiDoTransactionRequest) (*TransactionInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TransactionsAPIService.DoTransaction")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
