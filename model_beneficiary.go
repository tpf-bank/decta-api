...
type Beneficiary struct {
	...
	// Date (YYYY-MM-DD) of birth of the beneficiary
	BirthDate string `json:"birthDate"`
	// Country (ISO 3166-1 alpha-3) of beneficiary's citizenship
	CountryCode string `json:"countryCode"`
	// % of the shares or voting rights of the legal entity owned by the beneficiary
	PercentageOfControl string `json:"percentageOfControl"`
	// Type of ownership
...
// GetPercentageOfControl returns the PercentageOfControl field value
func (o *Beneficiary) GetPercentageOfControl() string {
	...
	return o.PercentageOfControl
}

// GetPercentageOfControlOk returns a tuple with the PercentageOfControl field value
// and a boolean to check if the value has been set.
func (o *Beneficiary) GetPercentageOfControlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PercentageOfControl, true
}

// SetPercentageOfControl sets field value
func (o *Beneficiary) SetPercentageOfControl(v string) {
	o.PercentageOfControl = v
}
...
func (o Beneficiary) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["percentageOfControl"] = o.PercentageOfControl
