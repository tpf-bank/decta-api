...
// checks if the BusinessClient type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessClient{}

// BusinessClient Provide requested information about business client
...
type _BusinessClient BusinessClient
...
func (o BusinessClient) MarshalJSON() ([]byte, error) {
...
func (o BusinessClient) ToMap() (map[string]interface{}, error) {
...
func (o *BusinessClient) UnmarshalJSON(data []byte) (err error) {
	...
	varBusinessClient := _BusinessClient{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBusinessClient)

	if err != nil {
		return err
	}

	*o = BusinessClient(varBusinessClient)

	return err
}

type NullableBusinessClient struct {
	value *BusinessClient
	isSet bool
}

func (v NullableBusinessClient) Get() *BusinessClient {
	return v.value
}

func (v *NullableBusinessClient) Set(val *BusinessClient) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessClient) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessClient) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessClient(val *BusinessClient) *NullableBusinessClient {
	return &NullableBusinessClient{value: val, isSet: true}
}

func (v NullableBusinessClient) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessClient) UnmarshalJSON(src []byte) error {
	v.isSet = true
