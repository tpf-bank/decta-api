...
// checks if the BusinessClientInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessClientInfo{}

// BusinessClientInfo Provide requested information about business client
type BusinessClientInfo struct {
	...
	// List of company beneficiaries - individuals who directly or indirectly controls at least 25% of the shares or voting rights of legal entity.
	Beneficiaries []Beneficiary `json:"beneficiaries,omitempty"`
	CardHolder    *Cardholder   `json:"cardHolder,omitempty"`
}

type _BusinessClientInfo BusinessClientInfo
...
// SetBeneficiaries gets a reference to the given []Beneficiary and assigns it to the Beneficiaries field.
...
// SetCardHolder gets a reference to the given Cardholder and assigns it to the CardHolder field.
func (o *BusinessClientInfo) SetCardHolder(v Cardholder) {
	o.CardHolder = &v
}

func (o BusinessClientInfo) MarshalJSON() ([]byte, error) {
...
func (o BusinessClientInfo) ToMap() (map[string]interface{}, error) {
...
func (o *BusinessClientInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varBusinessClientInfo := _BusinessClientInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBusinessClientInfo)

	if err != nil {
		return err
	}

	*o = BusinessClientInfo(varBusinessClientInfo)

	return err
}

type NullableBusinessClientInfo struct {
	value *BusinessClientInfo
	isSet bool
}

func (v NullableBusinessClientInfo) Get() *BusinessClientInfo {
	return v.value
}

func (v *NullableBusinessClientInfo) Set(val *BusinessClientInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessClientInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessClientInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessClientInfo(val *BusinessClientInfo) *NullableBusinessClientInfo {
	return &NullableBusinessClientInfo{value: val, isSet: true}
}

func (v NullableBusinessClientInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessClientInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
