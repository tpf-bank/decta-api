...
// checks if the CardAccountCurrencyInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardAccountCurrencyInfo{}

// CardAccountCurrencyInfo Card account currency information
type CardAccountCurrencyInfo struct {
	// Account currency priority level
	Priority *string `json:"priority,omitempty"`
	// Account currency status
	Status *string `json:"status,omitempty"`
	// Account currency alphabetical code
...
// GetLockedAmount returns the LockedAmount field value if set, zero value otherwise.
func (o *CardAccountCurrencyInfo) GetLockedAmount() string {
	if o == nil || IsNil(o.LockedAmount) {
		var ret string
		return ret
	}
...
// GetLockedAmountOk returns a tuple with the LockedAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLockedAmount gets a reference to the given string and assigns it to the LockedAmount field.
func (o *CardAccountCurrencyInfo) SetLockedAmount(v string) {
	o.LockedAmount = &v
}

func (o CardAccountCurrencyInfo) MarshalJSON() ([]byte, error) {
...
func (o CardAccountCurrencyInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LockedAmount) {
		toSerialize["lockedAmount"] = o.LockedAmount
	}
	return toSerialize, nil
}

type NullableCardAccountCurrencyInfo struct {
	value *CardAccountCurrencyInfo
	isSet bool
}

func (v NullableCardAccountCurrencyInfo) Get() *CardAccountCurrencyInfo {
	return v.value
}

func (v *NullableCardAccountCurrencyInfo) Set(val *CardAccountCurrencyInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCardAccountCurrencyInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCardAccountCurrencyInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardAccountCurrencyInfo(val *CardAccountCurrencyInfo) *NullableCardAccountCurrencyInfo {
	return &NullableCardAccountCurrencyInfo{value: val, isSet: true}
}

func (v NullableCardAccountCurrencyInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardAccountCurrencyInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
