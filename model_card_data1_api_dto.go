...
// checks if the CardData1ApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardData1ApiDto{}

// CardData1ApiDto Card Data 1 info
type CardData1ApiDto struct {
	// Card Data
	CardData string `json:"cardData"`
}

type _CardData1ApiDto CardData1ApiDto
...
func (o CardData1ApiDto) MarshalJSON() ([]byte, error) {
...
func (o CardData1ApiDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cardData"] = o.CardData
	return toSerialize, nil
}

func (o *CardData1ApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCardData1ApiDto := _CardData1ApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCardData1ApiDto)

	if err != nil {
		return err
	}

	*o = CardData1ApiDto(varCardData1ApiDto)

	return err
}

type NullableCardData1ApiDto struct {
	value *CardData1ApiDto
	isSet bool
}

func (v NullableCardData1ApiDto) Get() *CardData1ApiDto {
	return v.value
}

func (v *NullableCardData1ApiDto) Set(val *CardData1ApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCardData1ApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCardData1ApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardData1ApiDto(val *CardData1ApiDto) *NullableCardData1ApiDto {
	return &NullableCardData1ApiDto{value: val, isSet: true}
}

func (v NullableCardData1ApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardData1ApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
