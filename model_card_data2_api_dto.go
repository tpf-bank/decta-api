...
// checks if the CardData2ApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardData2ApiDto{}

// CardData2ApiDto Card Data 2 info
type CardData2ApiDto struct {
	// Card Data
	CardData string `json:"cardData"`
}

type _CardData2ApiDto CardData2ApiDto
...
func (o CardData2ApiDto) MarshalJSON() ([]byte, error) {
...
func (o CardData2ApiDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cardData"] = o.CardData
	return toSerialize, nil
}

func (o *CardData2ApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCardData2ApiDto := _CardData2ApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCardData2ApiDto)

	if err != nil {
		return err
	}

	*o = CardData2ApiDto(varCardData2ApiDto)

	return err
}

type NullableCardData2ApiDto struct {
	value *CardData2ApiDto
	isSet bool
}

func (v NullableCardData2ApiDto) Get() *CardData2ApiDto {
	return v.value
}

func (v *NullableCardData2ApiDto) Set(val *CardData2ApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCardData2ApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCardData2ApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardData2ApiDto(val *CardData2ApiDto) *NullableCardData2ApiDto {
	return &NullableCardData2ApiDto{value: val, isSet: true}
}

func (v NullableCardData2ApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardData2ApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
