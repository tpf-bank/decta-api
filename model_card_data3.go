...
// checks if the CardData3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardData3{}

// CardData3 Card Data 3 info
...
func (o CardData3) MarshalJSON() ([]byte, error) {
...
func (o CardData3) ToMap() (map[string]interface{}, error) {
...
type NullableCardData3 struct {
	value *CardData3
	isSet bool
}

func (v NullableCardData3) Get() *CardData3 {
	return v.value
}

func (v *NullableCardData3) Set(val *CardData3) {
	v.value = val
	v.isSet = true
}

func (v NullableCardData3) IsSet() bool {
	return v.isSet
}

func (v *NullableCardData3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardData3(val *CardData3) *NullableCardData3 {
	return &NullableCardData3{value: val, isSet: true}
}

func (v NullableCardData3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardData3) UnmarshalJSON(src []byte) error {
	v.isSet = true
