...
// checks if the CardData3HolderApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardData3HolderApiDto{}

// CardData3HolderApiDto Data3
type CardData3HolderApiDto struct {
	// Card pseudo-pan
	Ppan *string `json:"ppan,omitempty"`
	// CardData
	CardData []CardData3 `json:"cardData,omitempty"`
}
...
// GetCardData returns the CardData field value if set, zero value otherwise.
func (o *CardData3HolderApiDto) GetCardData() []CardData3 {
	if o == nil || IsNil(o.CardData) {
		var ret []CardData3
		return ret
	}
	return o.CardData
...
// GetCardDataOk returns a tuple with the CardData field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCardData gets a reference to the given []CardData3 and assigns it to the CardData field.
func (o *CardData3HolderApiDto) SetCardData(v []CardData3) {
	o.CardData = v
}

func (o CardData3HolderApiDto) MarshalJSON() ([]byte, error) {
...
func (o CardData3HolderApiDto) ToMap() (map[string]interface{}, error) {
...
type NullableCardData3HolderApiDto struct {
	value *CardData3HolderApiDto
	isSet bool
}

func (v NullableCardData3HolderApiDto) Get() *CardData3HolderApiDto {
	return v.value
}

func (v *NullableCardData3HolderApiDto) Set(val *CardData3HolderApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCardData3HolderApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCardData3HolderApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardData3HolderApiDto(val *CardData3HolderApiDto) *NullableCardData3HolderApiDto {
	return &NullableCardData3HolderApiDto{value: val, isSet: true}
}

func (v NullableCardData3HolderApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardData3HolderApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
