...
// checks if the CardData4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardData4{}

// CardData4 Card Data 4 info
type CardData4 struct {
	// Clear text primary account number
	Pan *string `json:"pan,omitempty"`
	// Cardholder name up to 26 symbols
...
// GetCvv2 returns the Cvv2 field value if set, zero value otherwise.
func (o *CardData4) GetCvv2() string {
	if o == nil || IsNil(o.Cvv2) {
		var ret string
		return ret
	}
	return *o.Cvv2
...
// GetCvv2Ok returns a tuple with the Cvv2 field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCvv2 gets a reference to the given string and assigns it to the Cvv2 field.
func (o *CardData4) SetCvv2(v string) {
	o.Cvv2 = &v
}

func (o CardData4) MarshalJSON() ([]byte, error) {
...
func (o CardData4) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Cvv2) {
		toSerialize["cvv2"] = o.Cvv2
	}
	return toSerialize, nil
}

type NullableCardData4 struct {
	value *CardData4
	isSet bool
}

func (v NullableCardData4) Get() *CardData4 {
	return v.value
}

func (v *NullableCardData4) Set(val *CardData4) {
	v.value = val
	v.isSet = true
}

func (v NullableCardData4) IsSet() bool {
	return v.isSet
}

func (v *NullableCardData4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardData4(val *CardData4) *NullableCardData4 {
	return &NullableCardData4{value: val, isSet: true}
}

func (v NullableCardData4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardData4) UnmarshalJSON(src []byte) error {
	v.isSet = true
