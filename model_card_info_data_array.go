...
// checks if the CardInfoDataArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardInfoDataArray{}

// CardInfoDataArray Requested card info data array with cursor
type CardInfoDataArray struct {
	// Requested card info data array
	Data []CardInfo `json:"data,omitempty"`
...
// SetData gets a reference to the given []CardInfo and assigns it to the Data field.
...
func (o CardInfoDataArray) MarshalJSON() ([]byte, error) {
...
func (o CardInfoDataArray) ToMap() (map[string]interface{}, error) {
...
type NullableCardInfoDataArray struct {
	value *CardInfoDataArray
	isSet bool
}

func (v NullableCardInfoDataArray) Get() *CardInfoDataArray {
	return v.value
}

func (v *NullableCardInfoDataArray) Set(val *CardInfoDataArray) {
	v.value = val
	v.isSet = true
}

func (v NullableCardInfoDataArray) IsSet() bool {
	return v.isSet
}

func (v *NullableCardInfoDataArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardInfoDataArray(val *CardInfoDataArray) *NullableCardInfoDataArray {
	return &NullableCardInfoDataArray{value: val, isSet: true}
}

func (v NullableCardInfoDataArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardInfoDataArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
