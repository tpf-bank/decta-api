...
var _ MappedNullable = &CardOrder{}

// CardOrder Provide requested information to order a card
type CardOrder struct {
	// Decta API user controlled field
	ExternalId     *string         `json:"externalId,omitempty"`
	PrivateClient  *PrivateClient  `json:"privateClient,omitempty"`
	BusinessClient *BusinessClient `json:"businessClient,omitempty"`
	Card           CardPreferences `json:"card"`
	Attachments    *Attachments    `json:"attachments,omitempty"`
}

type _CardOrder CardOrder
...
// SetPrivateClient gets a reference to the given PrivateClient and assigns it to the PrivateClient field.
...
// SetBusinessClient gets a reference to the given BusinessClient and assigns it to the BusinessClient field.
...
func (o *CardOrder) UnmarshalJSON(data []byte) (err error) {
	...
	varCardOrder := _CardOrder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCardOrder)

	if err != nil {
		return err
	}

	*o = CardOrder(varCardOrder)
