...
// checks if the CardPreferences type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardPreferences{}

// CardPreferences Provide requested information about ordering card preferences
type CardPreferences struct {
	...
	// Card account owner relation
	AccountOwnerRelation *string `json:"accountOwnerRelation,omitempty"`
	// Passphrase
...
type _CardPreferences CardPreferences
...
// SetHolder gets a reference to the given Cardholder and assigns it to the Holder field.
...
// GetAccountOwnerRelation returns the AccountOwnerRelation field value if set, zero value otherwise.
func (o *CardPreferences) GetAccountOwnerRelation() string {
	if o == nil || IsNil(o.AccountOwnerRelation) {
		var ret string
		return ret
	}
	return *o.AccountOwnerRelation
}

// GetAccountOwnerRelationOk returns a tuple with the AccountOwnerRelation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CardPreferences) GetAccountOwnerRelationOk() (*string, bool) {
	if o == nil || IsNil(o.AccountOwnerRelation) {
		return nil, false
	}
	return o.AccountOwnerRelation, true
}
...
// SetAccountOwnerRelation gets a reference to the given string and assigns it to the AccountOwnerRelation field.
func (o *CardPreferences) SetAccountOwnerRelation(v string) {
	o.AccountOwnerRelation = &v
}
...
func (o CardPreferences) MarshalJSON() ([]byte, error) {
...
func (o CardPreferences) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AccountOwnerRelation) {
		toSerialize["accountOwnerRelation"] = o.AccountOwnerRelation
	}
...
func (o *CardPreferences) UnmarshalJSON(data []byte) (err error) {
	...
	varCardPreferences := _CardPreferences{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCardPreferences)

	if err != nil {
		return err
	}

	*o = CardPreferences(varCardPreferences)

	return err
}

type NullableCardPreferences struct {
	value *CardPreferences
	isSet bool
}

func (v NullableCardPreferences) Get() *CardPreferences {
	return v.value
}

func (v *NullableCardPreferences) Set(val *CardPreferences) {
	v.value = val
	v.isSet = true
}

func (v NullableCardPreferences) IsSet() bool {
	return v.isSet
}

func (v *NullableCardPreferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardPreferences(val *CardPreferences) *NullableCardPreferences {
	return &NullableCardPreferences{value: val, isSet: true}
}

func (v NullableCardPreferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardPreferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
