...
// checks if the CardPreferencesGiftCardApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardPreferencesGiftCardApiDto{}

// CardPreferencesGiftCardApiDto Ordering card preferences
type CardPreferencesGiftCardApiDto struct {
	// productCode
	ProductCode string `json:"productCode"`
	// currencies
	Currencies      []string                      `json:"currencies"`
	DeliveryAddress DeliveryAddressGiftCardApiDto `json:"deliveryAddress"`
}

type _CardPreferencesGiftCardApiDto CardPreferencesGiftCardApiDto
...
func NewCardPreferencesGiftCardApiDto(productCode string, currencies []string, deliveryAddress DeliveryAddressGiftCardApiDto) *CardPreferencesGiftCardApiDto {
	this := CardPreferencesGiftCardApiDto{}
...
func (o *CardPreferencesGiftCardApiDto) GetDeliveryAddress() DeliveryAddressGiftCardApiDto {
	if o == nil {
		var ret DeliveryAddressGiftCardApiDto
		return ret
	}
...
func (o CardPreferencesGiftCardApiDto) MarshalJSON() ([]byte, error) {
...
func (o CardPreferencesGiftCardApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *CardPreferencesGiftCardApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCardPreferencesGiftCardApiDto := _CardPreferencesGiftCardApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCardPreferencesGiftCardApiDto)

	if err != nil {
		return err
	}

	*o = CardPreferencesGiftCardApiDto(varCardPreferencesGiftCardApiDto)

	return err
}

type NullableCardPreferencesGiftCardApiDto struct {
	value *CardPreferencesGiftCardApiDto
	isSet bool
}

func (v NullableCardPreferencesGiftCardApiDto) Get() *CardPreferencesGiftCardApiDto {
	return v.value
}

func (v *NullableCardPreferencesGiftCardApiDto) Set(val *CardPreferencesGiftCardApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCardPreferencesGiftCardApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCardPreferencesGiftCardApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardPreferencesGiftCardApiDto(val *CardPreferencesGiftCardApiDto) *NullableCardPreferencesGiftCardApiDto {
	return &NullableCardPreferencesGiftCardApiDto{value: val, isSet: true}
}

func (v NullableCardPreferencesGiftCardApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardPreferencesGiftCardApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
