...
// checks if the CardRenewInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardRenewInfo{}

// CardRenewInfo Card Renew information
type CardRenewInfo struct {
	// Ppan
...
func (o CardRenewInfo) MarshalJSON() ([]byte, error) {
...
func (o CardRenewInfo) ToMap() (map[string]interface{}, error) {
...
type NullableCardRenewInfo struct {
	value *CardRenewInfo
	isSet bool
}

func (v NullableCardRenewInfo) Get() *CardRenewInfo {
	return v.value
}

func (v *NullableCardRenewInfo) Set(val *CardRenewInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCardRenewInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCardRenewInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardRenewInfo(val *CardRenewInfo) *NullableCardRenewInfo {
	return &NullableCardRenewInfo{value: val, isSet: true}
}

func (v NullableCardRenewInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardRenewInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
