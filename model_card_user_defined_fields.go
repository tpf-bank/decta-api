...
// checks if the CardUserDefinedFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardUserDefinedFields{}

// CardUserDefinedFields Status change parameters
type CardUserDefinedFields struct {
...
func (o CardUserDefinedFields) MarshalJSON() ([]byte, error) {
...
func (o CardUserDefinedFields) ToMap() (map[string]interface{}, error) {
...
type NullableCardUserDefinedFields struct {
	value *CardUserDefinedFields
	isSet bool
}

func (v NullableCardUserDefinedFields) Get() *CardUserDefinedFields {
	return v.value
}

func (v *NullableCardUserDefinedFields) Set(val *CardUserDefinedFields) {
	v.value = val
	v.isSet = true
}

func (v NullableCardUserDefinedFields) IsSet() bool {
	return v.isSet
}

func (v *NullableCardUserDefinedFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardUserDefinedFields(val *CardUserDefinedFields) *NullableCardUserDefinedFields {
	return &NullableCardUserDefinedFields{value: val, isSet: true}
}

func (v NullableCardUserDefinedFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardUserDefinedFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
