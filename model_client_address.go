...
// checks if the ClientAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientAddress{}

// ClientAddress new client address data
...
func (o ClientAddress) MarshalJSON() ([]byte, error) {
...
func (o ClientAddress) ToMap() (map[string]interface{}, error) {
...
type NullableClientAddress struct {
	value *ClientAddress
	isSet bool
}

func (v NullableClientAddress) Get() *ClientAddress {
	return v.value
}

func (v *NullableClientAddress) Set(val *ClientAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableClientAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableClientAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientAddress(val *ClientAddress) *NullableClientAddress {
	return &NullableClientAddress{value: val, isSet: true}
}

func (v NullableClientAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClientAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
