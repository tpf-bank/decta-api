...
type ClientInfo struct {
	...
	PrivateClientInfo  *PrivateClient      `json:"privateClientInfo,omitempty"`
...
// SetPrivateClientInfo gets a reference to the given PrivateClient and assigns it to the PrivateClientInfo field.
