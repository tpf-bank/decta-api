...
// checks if the ClientInfoDataArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientInfoDataArray{}

// ClientInfoDataArray Requested client info data array with cursor
type ClientInfoDataArray struct {
	// Requested client info data array
...
func (o ClientInfoDataArray) MarshalJSON() ([]byte, error) {
...
func (o ClientInfoDataArray) ToMap() (map[string]interface{}, error) {
...
type NullableClientInfoDataArray struct {
	value *ClientInfoDataArray
	isSet bool
}

func (v NullableClientInfoDataArray) Get() *ClientInfoDataArray {
	return v.value
}

func (v *NullableClientInfoDataArray) Set(val *ClientInfoDataArray) {
	v.value = val
	v.isSet = true
}

func (v NullableClientInfoDataArray) IsSet() bool {
	return v.isSet
}

func (v *NullableClientInfoDataArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientInfoDataArray(val *ClientInfoDataArray) *NullableClientInfoDataArray {
	return &NullableClientInfoDataArray{value: val, isSet: true}
}

func (v NullableClientInfoDataArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClientInfoDataArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
