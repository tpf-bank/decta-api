...
// Contact Provide requested information about client main/supplement contact person
type Contact struct {
	...
	// Contact relation for private client or position for business client
	PositionRelation *string          `json:"position_relation,omitempty"`
	MailingAddress   *DeliveryAddress `json:"mailingAddress,omitempty"`
}
...
// GetPositionRelation returns the PositionRelation field value if set, zero value otherwise.
func (o *Contact) GetPositionRelation() string {
	if o == nil || IsNil(o.PositionRelation) {
		var ret string
		return ret
	}
	return *o.PositionRelation
}

// GetPositionRelationOk returns a tuple with the PositionRelation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Contact) GetPositionRelationOk() (*string, bool) {
	if o == nil || IsNil(o.PositionRelation) {
		return nil, false
	}
	return o.PositionRelation, true
}
...
// SetPositionRelation gets a reference to the given string and assigns it to the PositionRelation field.
func (o *Contact) SetPositionRelation(v string) {
	o.PositionRelation = &v
}
...
// SetMailingAddress gets a reference to the given DeliveryAddress and assigns it to the MailingAddress field.
...
func (o Contact) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PositionRelation) {
		toSerialize["position_relation"] = o.PositionRelation
	}
