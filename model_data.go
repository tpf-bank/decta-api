...
type Data struct {
	...
	TokenReferenceData []TokenReferenceData `json:"tokenReferenceData,omitempty"`
}
...
// GetTokenReferenceData returns the TokenReferenceData field value if set, zero value otherwise.
func (o *Data) GetTokenReferenceData() []TokenReferenceData {
	if o == nil || IsNil(o.TokenReferenceData) {
		var ret []TokenReferenceData
		return ret
	}
	return o.TokenReferenceData
}

// GetTokenReferenceDataOk returns a tuple with the TokenReferenceData field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Data) GetTokenReferenceDataOk() ([]TokenReferenceData, bool) {
	if o == nil || IsNil(o.TokenReferenceData) {
		return nil, false
	}
	return o.TokenReferenceData, true
}
...
// SetTokenReferenceData gets a reference to the given []TokenReferenceData and assigns it to the TokenReferenceData field.
func (o *Data) SetTokenReferenceData(v []TokenReferenceData) {
	o.TokenReferenceData = v
}
...
func (o Data) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TokenReferenceData) {
		toSerialize["tokenReferenceData"] = o.TokenReferenceData
	}
