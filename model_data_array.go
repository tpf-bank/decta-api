...
// checks if the DataArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataArray{}

// DataArray Requested data array
type DataArray struct {
	Data []TransactionsQueueInfo `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []TransactionsQueueInfo and assigns it to the Data field.
func (o *DataArray) SetData(v []TransactionsQueueInfo) {
	o.Data = v
}

func (o DataArray) MarshalJSON() ([]byte, error) {
...
func (o DataArray) ToMap() (map[string]interface{}, error) {
...
type NullableDataArray struct {
	value *DataArray
	isSet bool
}

func (v NullableDataArray) Get() *DataArray {
	return v.value
}

func (v *NullableDataArray) Set(val *DataArray) {
	v.value = val
	v.isSet = true
}

func (v NullableDataArray) IsSet() bool {
	return v.isSet
}

func (v *NullableDataArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataArray(val *DataArray) *NullableDataArray {
	return &NullableDataArray{value: val, isSet: true}
}

func (v NullableDataArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
