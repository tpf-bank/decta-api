...
// checks if the DectaSecureDeviceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DectaSecureDeviceDto{}

// DectaSecureDeviceDto Devices
type DectaSecureDeviceDto struct {
	// Date(YYYY-MM-DDTHH:mm:ss) of registration
	CreationDate *string `json:"creationDate,omitempty"`
	// Date(YYYY-MM-DDTHH:mm:ss) of last access
...
func (o DectaSecureDeviceDto) MarshalJSON() ([]byte, error) {
...
func (o DectaSecureDeviceDto) ToMap() (map[string]interface{}, error) {
...
type NullableDectaSecureDeviceDto struct {
	value *DectaSecureDeviceDto
	isSet bool
}

func (v NullableDectaSecureDeviceDto) Get() *DectaSecureDeviceDto {
	return v.value
}

func (v *NullableDectaSecureDeviceDto) Set(val *DectaSecureDeviceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableDectaSecureDeviceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableDectaSecureDeviceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDectaSecureDeviceDto(val *DectaSecureDeviceDto) *NullableDectaSecureDeviceDto {
	return &NullableDectaSecureDeviceDto{value: val, isSet: true}
}

func (v NullableDectaSecureDeviceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDectaSecureDeviceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
