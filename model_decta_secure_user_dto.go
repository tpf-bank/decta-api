...
// checks if the DectaSecureUserDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DectaSecureUserDto{}

// DectaSecureUserDto User
type DectaSecureUserDto struct {
	// User name
	UserName *string `json:"userName,omitempty"`
	// Active
	Active *bool `json:"active,omitempty"`
	// Date(YYYY-MM-DDTHH:mm:ss) of last modified
...
func (o DectaSecureUserDto) MarshalJSON() ([]byte, error) {
...
func (o DectaSecureUserDto) ToMap() (map[string]interface{}, error) {
...
type NullableDectaSecureUserDto struct {
	value *DectaSecureUserDto
	isSet bool
}

func (v NullableDectaSecureUserDto) Get() *DectaSecureUserDto {
	return v.value
}

func (v *NullableDectaSecureUserDto) Set(val *DectaSecureUserDto) {
	v.value = val
	v.isSet = true
}

func (v NullableDectaSecureUserDto) IsSet() bool {
	return v.isSet
}

func (v *NullableDectaSecureUserDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDectaSecureUserDto(val *DectaSecureUserDto) *NullableDectaSecureUserDto {
	return &NullableDectaSecureUserDto{value: val, isSet: true}
}

func (v NullableDectaSecureUserDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDectaSecureUserDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
