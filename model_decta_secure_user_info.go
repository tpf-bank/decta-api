...
// checks if the DectaSecureUserInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DectaSecureUserInfo{}

// DectaSecureUserInfo Decta secure user info
type DectaSecureUserInfo struct {
	User *DectaSecureUserDto `json:"user,omitempty"`
	// Devices
	Devices []DectaSecureDeviceDto `json:"devices,omitempty"`
}
...
// SetUser gets a reference to the given DectaSecureUserDto and assigns it to the User field.
...
// SetDevices gets a reference to the given []DectaSecureDeviceDto and assigns it to the Devices field.
func (o *DectaSecureUserInfo) SetDevices(v []DectaSecureDeviceDto) {
	o.Devices = v
}

func (o DectaSecureUserInfo) MarshalJSON() ([]byte, error) {
...
func (o DectaSecureUserInfo) ToMap() (map[string]interface{}, error) {
...
type NullableDectaSecureUserInfo struct {
	value *DectaSecureUserInfo
	isSet bool
}

func (v NullableDectaSecureUserInfo) Get() *DectaSecureUserInfo {
	return v.value
}

func (v *NullableDectaSecureUserInfo) Set(val *DectaSecureUserInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableDectaSecureUserInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableDectaSecureUserInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDectaSecureUserInfo(val *DectaSecureUserInfo) *NullableDectaSecureUserInfo {
	return &NullableDectaSecureUserInfo{value: val, isSet: true}
}

func (v NullableDectaSecureUserInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDectaSecureUserInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
