...
// checks if the DeliveryAddressGiftCardApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeliveryAddressGiftCardApiDto{}

// DeliveryAddressGiftCardApiDto deliveryAddress
type DeliveryAddressGiftCardApiDto struct {
	// Type of a card delivery
...
type _DeliveryAddressGiftCardApiDto DeliveryAddressGiftCardApiDto
...
func NewDeliveryAddressGiftCardApiDto(shipment string, name string, surname string, country string, city string, street string, zipCode string) *DeliveryAddressGiftCardApiDto {
	this := DeliveryAddressGiftCardApiDto{}
...
func (o DeliveryAddressGiftCardApiDto) MarshalJSON() ([]byte, error) {
...
func (o DeliveryAddressGiftCardApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *DeliveryAddressGiftCardApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varDeliveryAddressGiftCardApiDto := _DeliveryAddressGiftCardApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeliveryAddressGiftCardApiDto)

	if err != nil {
		return err
	}

	*o = DeliveryAddressGiftCardApiDto(varDeliveryAddressGiftCardApiDto)

	return err
}

type NullableDeliveryAddressGiftCardApiDto struct {
	value *DeliveryAddressGiftCardApiDto
	isSet bool
}

func (v NullableDeliveryAddressGiftCardApiDto) Get() *DeliveryAddressGiftCardApiDto {
	return v.value
}

func (v *NullableDeliveryAddressGiftCardApiDto) Set(val *DeliveryAddressGiftCardApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableDeliveryAddressGiftCardApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableDeliveryAddressGiftCardApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeliveryAddressGiftCardApiDto(val *DeliveryAddressGiftCardApiDto) *NullableDeliveryAddressGiftCardApiDto {
	return &NullableDeliveryAddressGiftCardApiDto{value: val, isSet: true}
}

func (v NullableDeliveryAddressGiftCardApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeliveryAddressGiftCardApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
