...
// checks if the GiftCardOrder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardOrder{}

// GiftCardOrder Gift card order object
type GiftCardOrder struct {
	// Decta API user controlled field
	ExternalId *string `json:"externalId,omitempty"`
	// Number of gift cards to create<br>min: 1<br>max: 10000
	Count    string         `json:"count"`
	Template TemplateApiDto `json:"template"`
}

type _GiftCardOrder GiftCardOrder
...
func (o GiftCardOrder) MarshalJSON() ([]byte, error) {
...
func (o GiftCardOrder) ToMap() (map[string]interface{}, error) {
...
func (o *GiftCardOrder) UnmarshalJSON(data []byte) (err error) {
	...
	varGiftCardOrder := _GiftCardOrder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGiftCardOrder)

	if err != nil {
		return err
	}

	*o = GiftCardOrder(varGiftCardOrder)

	return err
}

type NullableGiftCardOrder struct {
	value *GiftCardOrder
	isSet bool
}

func (v NullableGiftCardOrder) Get() *GiftCardOrder {
	return v.value
}

func (v *NullableGiftCardOrder) Set(val *GiftCardOrder) {
	v.value = val
	v.isSet = true
}

func (v NullableGiftCardOrder) IsSet() bool {
	return v.isSet
}

func (v *NullableGiftCardOrder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGiftCardOrder(val *GiftCardOrder) *NullableGiftCardOrder {
	return &NullableGiftCardOrder{value: val, isSet: true}
}

func (v NullableGiftCardOrder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGiftCardOrder) UnmarshalJSON(src []byte) error {
	v.isSet = true
