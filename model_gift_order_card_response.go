...
// checks if the GiftOrderCardResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftOrderCardResponse{}

// GiftOrderCardResponse struct for GiftOrderCardResponse
type GiftOrderCardResponse struct {
	// Order id
...
func (o GiftOrderCardResponse) MarshalJSON() ([]byte, error) {
...
func (o GiftOrderCardResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGiftOrderCardResponse struct {
	value *GiftOrderCardResponse
	isSet bool
}

func (v NullableGiftOrderCardResponse) Get() *GiftOrderCardResponse {
	return v.value
}

func (v *NullableGiftOrderCardResponse) Set(val *GiftOrderCardResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGiftOrderCardResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGiftOrderCardResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGiftOrderCardResponse(val *GiftOrderCardResponse) *NullableGiftOrderCardResponse {
	return &NullableGiftOrderCardResponse{value: val, isSet: true}
}

func (v NullableGiftOrderCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGiftOrderCardResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
