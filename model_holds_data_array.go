...
// checks if the HoldsDataArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HoldsDataArray{}

// HoldsDataArray Requested holds data array with cursor
type HoldsDataArray struct {
	// Requested holds data array
	Data []HoldInfo `json:"data,omitempty"`
...
// SetData gets a reference to the given []HoldInfo and assigns it to the Data field.
...
func (o HoldsDataArray) MarshalJSON() ([]byte, error) {
...
func (o HoldsDataArray) ToMap() (map[string]interface{}, error) {
...
type NullableHoldsDataArray struct {
	value *HoldsDataArray
	isSet bool
}

func (v NullableHoldsDataArray) Get() *HoldsDataArray {
	return v.value
}

func (v *NullableHoldsDataArray) Set(val *HoldsDataArray) {
	v.value = val
	v.isSet = true
}

func (v NullableHoldsDataArray) IsSet() bool {
	return v.isSet
}

func (v *NullableHoldsDataArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHoldsDataArray(val *HoldsDataArray) *NullableHoldsDataArray {
	return &NullableHoldsDataArray{value: val, isSet: true}
}

func (v NullableHoldsDataArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHoldsDataArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
