...
// SetIndividual gets a reference to the given LimitValues and assigns it to the Individual field.
...
// SetGroup gets a reference to the given LimitValues and assigns it to the Group field.
