...
// checks if the LimitValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LimitValues{}
...
func (o LimitValues) MarshalJSON() ([]byte, error) {
...
func (o LimitValues) ToMap() (map[string]interface{}, error) {
...
type NullableLimitValues struct {
	value *LimitValues
	isSet bool
}

func (v NullableLimitValues) Get() *LimitValues {
	return v.value
}

func (v *NullableLimitValues) Set(val *LimitValues) {
	v.value = val
	v.isSet = true
}

func (v NullableLimitValues) IsSet() bool {
	return v.isSet
}

func (v *NullableLimitValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLimitValues(val *LimitValues) *NullableLimitValues {
	return &NullableLimitValues{value: val, isSet: true}
}

func (v NullableLimitValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLimitValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
