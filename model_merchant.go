...
type Merchant struct {
	// Merchant specific terminal code
	TerminalId *string `json:"terminalId,omitempty"`
	// A code provided to merchants by a payment processor
	Id *string `json:"id,omitempty"`
	// Merchant’s name
	Name *string `json:"name,omitempty"`
	// A Merchant Category Code (MCC) - reflects the primary category in which the merchant does business
	CategoryCode *string `json:"categoryCode,omitempty"`
	// N – imprinter; P – POS including E-Commerce; A - ATM
