...
// checks if the OrderCardResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderCardResponse{}

// OrderCardResponse struct for OrderCardResponse
...
func (o OrderCardResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderCardResponse) ToMap() (map[string]interface{}, error) {
...
type NullableOrderCardResponse struct {
	value *OrderCardResponse
	isSet bool
}

func (v NullableOrderCardResponse) Get() *OrderCardResponse {
	return v.value
}

func (v *NullableOrderCardResponse) Set(val *OrderCardResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderCardResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderCardResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderCardResponse(val *OrderCardResponse) *NullableOrderCardResponse {
	return &NullableOrderCardResponse{value: val, isSet: true}
}

func (v NullableOrderCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderCardResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
