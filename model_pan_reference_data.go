...
// checks if the PanReferenceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PanReferenceData{}

// PanReferenceData struct for PanReferenceData
type PanReferenceData struct {
	// Card pseudo-pan
...
func (o PanReferenceData) MarshalJSON() ([]byte, error) {
...
func (o PanReferenceData) ToMap() (map[string]interface{}, error) {
...
type NullablePanReferenceData struct {
	value *PanReferenceData
	isSet bool
}

func (v NullablePanReferenceData) Get() *PanReferenceData {
	return v.value
}

func (v *NullablePanReferenceData) Set(val *PanReferenceData) {
	v.value = val
	v.isSet = true
}

func (v NullablePanReferenceData) IsSet() bool {
	return v.isSet
}

func (v *NullablePanReferenceData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePanReferenceData(val *PanReferenceData) *NullablePanReferenceData {
	return &NullablePanReferenceData{value: val, isSet: true}
}

func (v NullablePanReferenceData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePanReferenceData) UnmarshalJSON(src []byte) error {
	v.isSet = true
