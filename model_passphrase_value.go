...
// checks if the PassphraseValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PassphraseValue{}

// PassphraseValue new card passphrase value
type PassphraseValue struct {
	// Purposed to send passphrase value object to Decta api
	Value string `json:"value"`
}

type _PassphraseValue PassphraseValue
...
func (o PassphraseValue) MarshalJSON() ([]byte, error) {
...
func (o PassphraseValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["value"] = o.Value
	return toSerialize, nil
}

func (o *PassphraseValue) UnmarshalJSON(data []byte) (err error) {
	...
	varPassphraseValue := _PassphraseValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPassphraseValue)

	if err != nil {
		return err
	}

	*o = PassphraseValue(varPassphraseValue)

	return err
}

type NullablePassphraseValue struct {
	value *PassphraseValue
	isSet bool
}

func (v NullablePassphraseValue) Get() *PassphraseValue {
	return v.value
}

func (v *NullablePassphraseValue) Set(val *PassphraseValue) {
	v.value = val
	v.isSet = true
}

func (v NullablePassphraseValue) IsSet() bool {
	return v.isSet
}

func (v *NullablePassphraseValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePassphraseValue(val *PassphraseValue) *NullablePassphraseValue {
	return &NullablePassphraseValue{value: val, isSet: true}
}

func (v NullablePassphraseValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePassphraseValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
