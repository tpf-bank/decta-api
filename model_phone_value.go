...
// checks if the PhoneValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhoneValue{}

// PhoneValue new client phone number value
type PhoneValue struct {
	// Purposed to send phone value object to Decta api
	Value string `json:"value"`
}

type _PhoneValue PhoneValue
...
func (o PhoneValue) MarshalJSON() ([]byte, error) {
...
func (o PhoneValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["value"] = o.Value
	return toSerialize, nil
}

func (o *PhoneValue) UnmarshalJSON(data []byte) (err error) {
	...
	varPhoneValue := _PhoneValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhoneValue)

	if err != nil {
		return err
	}

	*o = PhoneValue(varPhoneValue)

	return err
}

type NullablePhoneValue struct {
	value *PhoneValue
	isSet bool
}

func (v NullablePhoneValue) Get() *PhoneValue {
	return v.value
}

func (v *NullablePhoneValue) Set(val *PhoneValue) {
	v.value = val
	v.isSet = true
}

func (v NullablePhoneValue) IsSet() bool {
	return v.isSet
}

func (v *NullablePhoneValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhoneValue(val *PhoneValue) *NullablePhoneValue {
	return &NullablePhoneValue{value: val, isSet: true}
}

func (v NullablePhoneValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhoneValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
