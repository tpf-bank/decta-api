...
// checks if the PinAssign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinAssign{}

// PinAssign PinAssign
type PinAssign struct {
	// Card expiry in format [MMYY]
	Expiry string `json:"expiry"`
	// PIN Block encrypted under the public key certificate. Pin length should be equal to 4
	EncryptedPINBlock string `json:"encryptedPINBlock"`
	// Public key certificate used for encryption thumbprint
	EncryptionCertificateThumbprint string `json:"encryptionCertificateThumbprint"`
}

type _PinAssign PinAssign
...
// GetEncryptionCertificateThumbprint returns the EncryptionCertificateThumbprint field value
func (o *PinAssign) GetEncryptionCertificateThumbprint() string {
	...
	return o.EncryptionCertificateThumbprint
}

// GetEncryptionCertificateThumbprintOk returns a tuple with the EncryptionCertificateThumbprint field value
// and a boolean to check if the value has been set.
func (o *PinAssign) GetEncryptionCertificateThumbprintOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.EncryptionCertificateThumbprint, true
}

// SetEncryptionCertificateThumbprint sets field value
func (o *PinAssign) SetEncryptionCertificateThumbprint(v string) {
	o.EncryptionCertificateThumbprint = v
}

func (o PinAssign) MarshalJSON() ([]byte, error) {
...
func (o PinAssign) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["expiry"] = o.Expiry
	toSerialize["encryptedPINBlock"] = o.EncryptedPINBlock
	toSerialize["encryptionCertificateThumbprint"] = o.EncryptionCertificateThumbprint
	return toSerialize, nil
}

func (o *PinAssign) UnmarshalJSON(data []byte) (err error) {
	...
	varPinAssign := _PinAssign{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPinAssign)

	if err != nil {
		return err
	}

	*o = PinAssign(varPinAssign)

	return err
}

type NullablePinAssign struct {
	value *PinAssign
	isSet bool
}

func (v NullablePinAssign) Get() *PinAssign {
	return v.value
}

func (v *NullablePinAssign) Set(val *PinAssign) {
	v.value = val
	v.isSet = true
}

func (v NullablePinAssign) IsSet() bool {
	return v.isSet
}

func (v *NullablePinAssign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePinAssign(val *PinAssign) *NullablePinAssign {
	return &NullablePinAssign{value: val, isSet: true}
}

func (v NullablePinAssign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePinAssign) UnmarshalJSON(src []byte) error {
	v.isSet = true
