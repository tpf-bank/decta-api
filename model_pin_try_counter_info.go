...
// checks if the PinTryCounterInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinTryCounterInfo{}

// PinTryCounterInfo struct for PinTryCounterInfo
type PinTryCounterInfo struct {
	// PIN try count
	PinTryCount *string `json:"pinTryCount,omitempty"`
	// Last unsuccessful date of online pin try
...
// GetPinTryCount returns the PinTryCount field value if set, zero value otherwise.
func (o *PinTryCounterInfo) GetPinTryCount() string {
	if o == nil || IsNil(o.PinTryCount) {
		var ret string
		return ret
	}
	return *o.PinTryCount
}

// GetPinTryCountOk returns a tuple with the PinTryCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PinTryCounterInfo) GetPinTryCountOk() (*string, bool) {
	if o == nil || IsNil(o.PinTryCount) {
		return nil, false
	}
	return o.PinTryCount, true
}
...
// SetPinTryCount gets a reference to the given string and assigns it to the PinTryCount field.
...
func (o PinTryCounterInfo) MarshalJSON() ([]byte, error) {
...
func (o PinTryCounterInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PinTryCount) {
		toSerialize["pinTryCount"] = o.PinTryCount
	}
...
type NullablePinTryCounterInfo struct {
	value *PinTryCounterInfo
	isSet bool
}

func (v NullablePinTryCounterInfo) Get() *PinTryCounterInfo {
	return v.value
}

func (v *NullablePinTryCounterInfo) Set(val *PinTryCounterInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePinTryCounterInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePinTryCounterInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePinTryCounterInfo(val *PinTryCounterInfo) *NullablePinTryCounterInfo {
	return &NullablePinTryCounterInfo{value: val, isSet: true}
}

func (v NullablePinTryCounterInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePinTryCounterInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
