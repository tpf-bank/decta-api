...
func (o *PrivateClient) UnmarshalJSON(data []byte) (err error) {
	...
	varPrivateClient := _PrivateClient{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrivateClient)

	if err != nil {
		return err
	}

	*o = PrivateClient(varPrivateClient)
