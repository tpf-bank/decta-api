...
// checks if the PrivateClientGiftCardApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrivateClientGiftCardApiDto{}

// PrivateClientGiftCardApiDto Private client information
type PrivateClientGiftCardApiDto struct {
	// Name
	...
	CurrentAddress RegistrationAddressGiftCardApiDto `json:"currentAddress"`
	// Communication language (ISO 639-1)
	Language string `json:"language"`
}

type _PrivateClientGiftCardApiDto PrivateClientGiftCardApiDto
...
func NewPrivateClientGiftCardApiDto(name string, surname string, maidenName string, currentAddress RegistrationAddressGiftCardApiDto, language string) *PrivateClientGiftCardApiDto {
	this := PrivateClientGiftCardApiDto{}
	this.Name = name
...
// GetCurrentAddress returns the CurrentAddress field value
func (o *PrivateClientGiftCardApiDto) GetCurrentAddress() RegistrationAddressGiftCardApiDto {
	if o == nil {
		var ret RegistrationAddressGiftCardApiDto
		return ret
	}
...
// GetCurrentAddressOk returns a tuple with the CurrentAddress field value
// and a boolean to check if the value has been set.
...
// SetCurrentAddress sets field value
...
func (o PrivateClientGiftCardApiDto) MarshalJSON() ([]byte, error) {
...
func (o PrivateClientGiftCardApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *PrivateClientGiftCardApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varPrivateClientGiftCardApiDto := _PrivateClientGiftCardApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrivateClientGiftCardApiDto)

	if err != nil {
		return err
	}

	*o = PrivateClientGiftCardApiDto(varPrivateClientGiftCardApiDto)

	return err
}

type NullablePrivateClientGiftCardApiDto struct {
	value *PrivateClientGiftCardApiDto
	isSet bool
}

func (v NullablePrivateClientGiftCardApiDto) Get() *PrivateClientGiftCardApiDto {
	return v.value
}

func (v *NullablePrivateClientGiftCardApiDto) Set(val *PrivateClientGiftCardApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateClientGiftCardApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateClientGiftCardApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateClientGiftCardApiDto(val *PrivateClientGiftCardApiDto) *NullablePrivateClientGiftCardApiDto {
	return &NullablePrivateClientGiftCardApiDto{value: val, isSet: true}
}

func (v NullablePrivateClientGiftCardApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateClientGiftCardApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
