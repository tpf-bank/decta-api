...
// checks if the RegistrationAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistrationAddress{}

// RegistrationAddress Private client current registration address
...
type _RegistrationAddress RegistrationAddress
...
func (o RegistrationAddress) MarshalJSON() ([]byte, error) {
...
func (o RegistrationAddress) ToMap() (map[string]interface{}, error) {
...
func (o *RegistrationAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varRegistrationAddress := _RegistrationAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegistrationAddress)

	if err != nil {
		return err
	}

	*o = RegistrationAddress(varRegistrationAddress)

	return err
}

type NullableRegistrationAddress struct {
	value *RegistrationAddress
	isSet bool
}

func (v NullableRegistrationAddress) Get() *RegistrationAddress {
	return v.value
}

func (v *NullableRegistrationAddress) Set(val *RegistrationAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistrationAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableRegistrationAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegistrationAddress(val *RegistrationAddress) *NullableRegistrationAddress {
	return &NullableRegistrationAddress{value: val, isSet: true}
}

func (v NullableRegistrationAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegistrationAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
