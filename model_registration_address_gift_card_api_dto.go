...
// checks if the RegistrationAddressGiftCardApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistrationAddressGiftCardApiDto{}

// RegistrationAddressGiftCardApiDto Current Address
type RegistrationAddressGiftCardApiDto struct {
	// Period of living at address in months
...
type _RegistrationAddressGiftCardApiDto RegistrationAddressGiftCardApiDto
...
func NewRegistrationAddressGiftCardApiDto(months string, country string, city string, street string, zipCode string) *RegistrationAddressGiftCardApiDto {
	this := RegistrationAddressGiftCardApiDto{}
	this.Months = months
...
func (o RegistrationAddressGiftCardApiDto) MarshalJSON() ([]byte, error) {
...
func (o RegistrationAddressGiftCardApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *RegistrationAddressGiftCardApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varRegistrationAddressGiftCardApiDto := _RegistrationAddressGiftCardApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegistrationAddressGiftCardApiDto)

	if err != nil {
		return err
	}

	*o = RegistrationAddressGiftCardApiDto(varRegistrationAddressGiftCardApiDto)

	return err
}

type NullableRegistrationAddressGiftCardApiDto struct {
	value *RegistrationAddressGiftCardApiDto
	isSet bool
}

func (v NullableRegistrationAddressGiftCardApiDto) Get() *RegistrationAddressGiftCardApiDto {
	return v.value
}

func (v *NullableRegistrationAddressGiftCardApiDto) Set(val *RegistrationAddressGiftCardApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistrationAddressGiftCardApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableRegistrationAddressGiftCardApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegistrationAddressGiftCardApiDto(val *RegistrationAddressGiftCardApiDto) *NullableRegistrationAddressGiftCardApiDto {
	return &NullableRegistrationAddressGiftCardApiDto{value: val, isSet: true}
}

func (v NullableRegistrationAddressGiftCardApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegistrationAddressGiftCardApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
