...
// checks if the TemplateApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateApiDto{}

// TemplateApiDto Provide requested information to batch order gift card
type TemplateApiDto struct {
	PrivateClient PrivateClientGiftCardApiDto   `json:"privateClient"`
	Card          CardPreferencesGiftCardApiDto `json:"card"`
}

type _TemplateApiDto TemplateApiDto
...
func (o *TemplateApiDto) GetPrivateClient() PrivateClientGiftCardApiDto {
	if o == nil {
		var ret PrivateClientGiftCardApiDto
		return ret
	}
...
func (o *TemplateApiDto) GetCard() CardPreferencesGiftCardApiDto {
	if o == nil {
		var ret CardPreferencesGiftCardApiDto
		return ret
	}
...
func (o TemplateApiDto) MarshalJSON() ([]byte, error) {
...
func (o TemplateApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *TemplateApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varTemplateApiDto := _TemplateApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTemplateApiDto)

	if err != nil {
		return err
	}

	*o = TemplateApiDto(varTemplateApiDto)

	return err
}

type NullableTemplateApiDto struct {
	value *TemplateApiDto
	isSet bool
}

func (v NullableTemplateApiDto) Get() *TemplateApiDto {
	return v.value
}

func (v *NullableTemplateApiDto) Set(val *TemplateApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateApiDto(val *TemplateApiDto) *NullableTemplateApiDto {
	return &NullableTemplateApiDto{value: val, isSet: true}
}

func (v NullableTemplateApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
