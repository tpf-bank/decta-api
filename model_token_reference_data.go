...
// checks if the TokenReferenceData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenReferenceData{}

// TokenReferenceData Token Reference Data
type TokenReferenceData struct {
	// Token reference ID
...
func (o TokenReferenceData) MarshalJSON() ([]byte, error) {
...
func (o TokenReferenceData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TokenReferenceId) {
		toSerialize["tokenReferenceId"] = o.TokenReferenceId
	}
	if !IsNil(o.TokenRequestorId) {
		toSerialize["tokenRequestorId"] = o.TokenRequestorId
	}
	if !IsNil(o.WalletId) {
...
type NullableTokenReferenceData struct {
	value *TokenReferenceData
	isSet bool
}

func (v NullableTokenReferenceData) Get() *TokenReferenceData {
	return v.value
}

func (v *NullableTokenReferenceData) Set(val *TokenReferenceData) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenReferenceData) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenReferenceData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenReferenceData(val *TokenReferenceData) *NullableTokenReferenceData {
	return &NullableTokenReferenceData{value: val, isSet: true}
}

func (v NullableTokenReferenceData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenReferenceData) UnmarshalJSON(src []byte) error {
	v.isSet = true
