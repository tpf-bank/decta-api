...
// checks if the TokenStatusChange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenStatusChange{}

// TokenStatusChange struct for TokenStatusChange
type TokenStatusChange struct {
	// Desirable token status
	TokenStatus string `json:"tokenStatus"`
	// Reason for token status change
	Details string `json:"details"`
}

type _TokenStatusChange TokenStatusChange
...
func (o TokenStatusChange) MarshalJSON() ([]byte, error) {
...
func (o TokenStatusChange) ToMap() (map[string]interface{}, error) {
...
func (o *TokenStatusChange) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenStatusChange := _TokenStatusChange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenStatusChange)

	if err != nil {
		return err
	}

	*o = TokenStatusChange(varTokenStatusChange)

	return err
}

type NullableTokenStatusChange struct {
	value *TokenStatusChange
	isSet bool
}

func (v NullableTokenStatusChange) Get() *TokenStatusChange {
	return v.value
}

func (v *NullableTokenStatusChange) Set(val *TokenStatusChange) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenStatusChange) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenStatusChange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenStatusChange(val *TokenStatusChange) *NullableTokenStatusChange {
	return &NullableTokenStatusChange{value: val, isSet: true}
}

func (v NullableTokenStatusChange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenStatusChange) UnmarshalJSON(src []byte) error {
	v.isSet = true
