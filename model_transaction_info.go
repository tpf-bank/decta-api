...
type TransactionInfo struct {
	...
	// Financial transactions settlement date in the system
	...
	// System Trace Audit Number - a unique number identifying a payment transaction
	...
	// A code that indicates approval or denial for an authorization request
	...
	// Transaction exchange rate value
	ExchangeRate *string `json:"exchangeRate,omitempty"`
	Markup       *Amount `json:"markup,omitempty"`
}
...
// SetPostDate gets a reference to the given string and assigns it to the PostDate field.
...
// SetStan gets a reference to the given string and assigns it to the Stan field.
...
// SetReferenceData gets a reference to the given string and assigns it to the ReferenceData field.
...
// GetSlipNumber returns the SlipNumber field value if set, zero value otherwise.
func (o *TransactionInfo) GetSlipNumber() string {
	if o == nil || IsNil(o.SlipNumber) {
		var ret string
		return ret
	}
	return *o.SlipNumber
...
// GetSlipNumberOk returns a tuple with the SlipNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionInfo) GetSlipNumberOk() (*string, bool) {
	if o == nil || IsNil(o.SlipNumber) {
		return nil, false
	}
	return o.SlipNumber, true
}
...
// SetSlipNumber gets a reference to the given string and assigns it to the SlipNumber field.
...
// SetMarkup gets a reference to the given Amount and assigns it to the Markup field.
...
func (o TransactionInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SlipNumber) {
		toSerialize["slipNumber"] = o.SlipNumber
	}
