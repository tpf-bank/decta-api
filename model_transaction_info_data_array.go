...
// checks if the TransactionInfoDataArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionInfoDataArray{}

// TransactionInfoDataArray Requested transaction info data array with cursor
type TransactionInfoDataArray struct {
	// Requested transaction info data array
	Data []TransactionInfo `json:"data,omitempty"`
	// Next item cursor. No more data if cursor is empty
...
// SetData gets a reference to the given []TransactionInfo and assigns it to the Data field.
...
func (o TransactionInfoDataArray) MarshalJSON() ([]byte, error) {
...
func (o TransactionInfoDataArray) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionInfoDataArray struct {
	value *TransactionInfoDataArray
	isSet bool
}

func (v NullableTransactionInfoDataArray) Get() *TransactionInfoDataArray {
	return v.value
}

func (v *NullableTransactionInfoDataArray) Set(val *TransactionInfoDataArray) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionInfoDataArray) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionInfoDataArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionInfoDataArray(val *TransactionInfoDataArray) *NullableTransactionInfoDataArray {
	return &NullableTransactionInfoDataArray{value: val, isSet: true}
}

func (v NullableTransactionInfoDataArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionInfoDataArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
