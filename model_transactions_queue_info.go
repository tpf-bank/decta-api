...
// checks if the TransactionsQueueInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionsQueueInfo{}

// TransactionsQueueInfo Queued transaction info
type TransactionsQueueInfo struct {
	// An identification number of the transaction
...
func (o TransactionsQueueInfo) MarshalJSON() ([]byte, error) {
...
func (o TransactionsQueueInfo) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionsQueueInfo struct {
	value *TransactionsQueueInfo
	isSet bool
}

func (v NullableTransactionsQueueInfo) Get() *TransactionsQueueInfo {
	return v.value
}

func (v *NullableTransactionsQueueInfo) Set(val *TransactionsQueueInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionsQueueInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionsQueueInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionsQueueInfo(val *TransactionsQueueInfo) *NullableTransactionsQueueInfo {
	return &NullableTransactionsQueueInfo{value: val, isSet: true}
}

func (v NullableTransactionsQueueInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionsQueueInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
