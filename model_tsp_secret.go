...
// checks if the TspSecret type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TspSecret{}

// TspSecret TSP Secret
type TspSecret struct {
	// Card pseudo-pan
...
func (o TspSecret) MarshalJSON() ([]byte, error) {
...
func (o TspSecret) ToMap() (map[string]interface{}, error) {
...
type NullableTspSecret struct {
	value *TspSecret
	isSet bool
}

func (v NullableTspSecret) Get() *TspSecret {
	return v.value
}

func (v *NullableTspSecret) Set(val *TspSecret) {
	v.value = val
	v.isSet = true
}

func (v NullableTspSecret) IsSet() bool {
	return v.isSet
}

func (v *NullableTspSecret) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTspSecret(val *TspSecret) *NullableTspSecret {
	return &NullableTspSecret{value: val, isSet: true}
}

func (v NullableTspSecret) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTspSecret) UnmarshalJSON(src []byte) error {
	v.isSet = true
