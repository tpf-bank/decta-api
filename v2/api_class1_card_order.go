...
// Class1CardOrderAPIService Class1CardOrderAPI service
type Class1CardOrderAPIService service

type ApiGetOrdersListRequest struct {
	ctx context.Context
	ApiService *Class1CardOrderAPIService
	requestId *string
	tokenHeader *string
...
func (r ApiGetOrdersListRequest) RequestId(requestId string) ApiGetOrdersListRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetOrdersListRequest) TokenHeader(tokenHeader string) ApiGetOrdersListRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetOrdersListRequest) TokenSignature(tokenSignature string) ApiGetOrdersListRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// start from document with id
func (r ApiGetOrdersListRequest) Id(id string) ApiGetOrdersListRequest {
	r.id = &id
	return r
}

// get documents with externalId
func (r ApiGetOrdersListRequest) ExternalId(externalId string) ApiGetOrdersListRequest {
	r.externalId = &externalId
	return r
}

// number of card orders&lt;/br&gt;max: 10000
func (r ApiGetOrdersListRequest) Count(count int32) ApiGetOrdersListRequest {
	r.count = &count
	return r
}

func (r ApiGetOrdersListRequest) Execute() ([]Order, *http.Response, error) {
	return r.ApiService.GetOrdersListExecute(r)
}

/*
GetOrdersList Order status

The request returns users a list of your card orders. The card orders are sorted in descending order by creation date, with the most recently created object appearing as first. To receive a list of orders starting in a particular order, provide either a specific id or an external Id number.<p>
<ul><h3>Order status possible values:</h3>    <li>REGISTERED – a card order is registered in the system and awaiting the launch of the manual card issue process</li>
    <li>PROCESSING – a card order is registered and is awaiting for manual processing</li>
    <li>DUPLICATES_FOUND – a card order is registered but duplicate orders have been identified</li>
    <li>COMPLETED – a card order is registered and completed</li>
    <li>REJECTED – a card order is registered but issuing has failed</li>
</ul>
</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetOrdersListRequest
*/
func (a *Class1CardOrderAPIService) GetOrdersList(ctx context.Context) ApiGetOrdersListRequest {
	return ApiGetOrdersListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []Order
func (a *Class1CardOrderAPIService) GetOrdersListExecute(r ApiGetOrdersListRequest) ([]Order, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class1CardOrderAPIService.GetOrdersList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/orders"
...
type ApiOrderCardRequest struct {
	ctx context.Context
	ApiService *Class1CardOrderAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiOrderCardRequest) RequestId(requestId string) ApiOrderCardRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiOrderCardRequest) TokenHeader(tokenHeader string) ApiOrderCardRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiOrderCardRequest) TokenSignature(tokenSignature string) ApiOrderCardRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiOrderCardRequest) CardOrder(cardOrder CardOrder) ApiOrderCardRequest {
	r.cardOrder = &cardOrder
	return r
}

func (r ApiOrderCardRequest) Execute() (*OrderCardResponse, *http.Response, error) {
	return r.ApiService.OrderCardExecute(r)
}

/*
OrderCard Order card

The request allows users to: <ul><li>Order a new private or business card with new Card Account</li><li>Add a supplementary card to existing Card Account</li></ul><p>To create order for private cards should be used Private Client mandatory fields.</p><p>To create order for business cards should be used Business Client mandatory fields.</p><p>Client data examples for both private and business card orders can be found <a href='/order_card.html' target='_blank'>here</a>.</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiOrderCardRequest
*/
func (a *Class1CardOrderAPIService) OrderCard(ctx context.Context) ApiOrderCardRequest {
	return ApiOrderCardRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *Class1CardOrderAPIService) OrderCardExecute(r ApiOrderCardRequest) (*OrderCardResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OrderCardResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class1CardOrderAPIService.OrderCard")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/order"
	...
	if r.cardOrder == nil {
		return localVarReturnValue, nil, reportError("cardOrder is required and must be specified")
	}
...
type ApiOrderGiftCardRequest struct {
	ctx context.Context
	ApiService *Class1CardOrderAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiOrderGiftCardRequest) RequestId(requestId string) ApiOrderGiftCardRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiOrderGiftCardRequest) TokenHeader(tokenHeader string) ApiOrderGiftCardRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiOrderGiftCardRequest) TokenSignature(tokenSignature string) ApiOrderGiftCardRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiOrderGiftCardRequest) GiftCardOrder(giftCardOrder GiftCardOrder) ApiOrderGiftCardRequest {
	r.giftCardOrder = &giftCardOrder
	return r
}

func (r ApiOrderGiftCardRequest) Execute() (*GiftOrderCardResponse, *http.Response, error) {
	return r.ApiService.OrderGiftCardExecute(r)
}

/*
OrderGiftCard Create gift cards

The request allows users to order gift cards

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiOrderGiftCardRequest
*/
func (a *Class1CardOrderAPIService) OrderGiftCard(ctx context.Context) ApiOrderGiftCardRequest {
	return ApiOrderGiftCardRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GiftOrderCardResponse
func (a *Class1CardOrderAPIService) OrderGiftCardExecute(r ApiOrderGiftCardRequest) (*GiftOrderCardResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GiftOrderCardResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class1CardOrderAPIService.OrderGiftCard")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/order-gift-card"
	...
	if r.giftCardOrder == nil {
		return localVarReturnValue, nil, reportError("giftCardOrder is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "token-signature", r.tokenSignature, "simple", "")
	// body params
	localVarPostBody = r.giftCardOrder
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
