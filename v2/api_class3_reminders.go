...
// Class3RemindersAPIService Class3RemindersAPI service
type Class3RemindersAPIService service

type ApiGetPinTryCounterRequest struct {
	ctx context.Context
	ApiService *Class3RemindersAPIService
	requestId *string
	tokenHeader *string
...
func (r ApiGetPinTryCounterRequest) RequestId(requestId string) ApiGetPinTryCounterRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetPinTryCounterRequest) TokenHeader(tokenHeader string) ApiGetPinTryCounterRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetPinTryCounterRequest) TokenSignature(tokenSignature string) ApiGetPinTryCounterRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiGetPinTryCounterRequest) Execute() (*PinTryCounterInfo, *http.Response, error) {
	return r.ApiService.GetPinTryCounterExecute(r)
}

/*
GetPinTryCounter Receive count of PIN code entry tries

The request allows card holders to receive the current count of PIN entry tries.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiGetPinTryCounterRequest
*/
func (a *Class3RemindersAPIService) GetPinTryCounter(ctx context.Context, ppan string) ApiGetPinTryCounterRequest {
	return ApiGetPinTryCounterRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
//  @return PinTryCounterInfo
func (a *Class3RemindersAPIService) GetPinTryCounterExecute(r ApiGetPinTryCounterRequest) (*PinTryCounterInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PinTryCounterInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class3RemindersAPIService.GetPinTryCounter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/{ppan}/pin-try-counter"
...
type ApiRemindPanCvvRequest struct {
	ctx context.Context
	ApiService *Class3RemindersAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiRemindPanCvvRequest) RequestId(requestId string) ApiRemindPanCvvRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiRemindPanCvvRequest) TokenHeader(tokenHeader string) ApiRemindPanCvvRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiRemindPanCvvRequest) TokenSignature(tokenSignature string) ApiRemindPanCvvRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiRemindPanCvvRequest) Execute() (*http.Response, error) {
	return r.ApiService.RemindPanCvvExecute(r)
}

/*
RemindPanCvv Remind card number

The request allows the system to send a SMS with the middle part of PAN and CVV of a virtual card to the cardholder's registered mobile phone number. The request must contain a specific PPAN.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiRemindPanCvvRequest
*/
func (a *Class3RemindersAPIService) RemindPanCvv(ctx context.Context, ppan string) ApiRemindPanCvvRequest {
	return ApiRemindPanCvvRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
func (a *Class3RemindersAPIService) RemindPanCvvExecute(r ApiRemindPanCvvRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class3RemindersAPIService.RemindPanCvv")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/{ppan}/pan-cvv"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
...
type ApiRemindPinRequest struct {
	ctx context.Context
	ApiService *Class3RemindersAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiRemindPinRequest) RequestId(requestId string) ApiRemindPinRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiRemindPinRequest) TokenHeader(tokenHeader string) ApiRemindPinRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiRemindPinRequest) TokenSignature(tokenSignature string) ApiRemindPinRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiRemindPinRequest) Execute() (*http.Response, error) {
	return r.ApiService.RemindPinExecute(r)
}

/*
RemindPin Remind PIN code

The request allows card holders to receive actual PIN code via SMS.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiRemindPinRequest
*/
func (a *Class3RemindersAPIService) RemindPin(ctx context.Context, ppan string) ApiRemindPinRequest {
	return ApiRemindPinRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
func (a *Class3RemindersAPIService) RemindPinExecute(r ApiRemindPinRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class3RemindersAPIService.RemindPin")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/{ppan}/pin"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
...
type ApiResetPinTryCounterRequest struct {
	ctx context.Context
	ApiService *Class3RemindersAPIService
	requestId *string
	tokenHeader *string
	tokenSignature *string
	ppan string
	pinTryReset *PinTryReset
}

// Request ID (UUID format)
func (r ApiResetPinTryCounterRequest) RequestId(requestId string) ApiResetPinTryCounterRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiResetPinTryCounterRequest) TokenHeader(tokenHeader string) ApiResetPinTryCounterRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiResetPinTryCounterRequest) TokenSignature(tokenSignature string) ApiResetPinTryCounterRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiResetPinTryCounterRequest) PinTryReset(pinTryReset PinTryReset) ApiResetPinTryCounterRequest {
	r.pinTryReset = &pinTryReset
	return r
}

func (r ApiResetPinTryCounterRequest) Execute() (*http.Response, error) {
	return r.ApiService.ResetPinTryCounterExecute(r)
}

/*
ResetPinTryCounter Reset count of PIN code entry tries

The request allows user to reset the PIN try counter for specific card.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiResetPinTryCounterRequest
*/
func (a *Class3RemindersAPIService) ResetPinTryCounter(ctx context.Context, ppan string) ApiResetPinTryCounterRequest {
	return ApiResetPinTryCounterRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
func (a *Class3RemindersAPIService) ResetPinTryCounterExecute(r ApiResetPinTryCounterRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class3RemindersAPIService.ResetPinTryCounter")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "token-signature", r.tokenSignature, "simple", "")
	// body params
	localVarPostBody = r.pinTryReset
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
