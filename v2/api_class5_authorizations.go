...
// Class5AuthorizationsAPIService Class5AuthorizationsAPI service
type Class5AuthorizationsAPIService service

type ApiGetHoldsListRequest struct {
	ctx context.Context
	ApiService *Class5AuthorizationsAPIService
	requestId *string
	tokenHeader *string
...
func (r ApiGetHoldsListRequest) RequestId(requestId string) ApiGetHoldsListRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetHoldsListRequest) TokenHeader(tokenHeader string) ApiGetHoldsListRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetHoldsListRequest) TokenSignature(tokenSignature string) ApiGetHoldsListRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiGetHoldsListRequest) Execute() (*HoldsDataArray, *http.Response, error) {
	return r.ApiService.GetHoldsListExecute(r)
}

/*
GetHoldsList Get card authorizations

The request allows users to receive list of current holds.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiGetHoldsListRequest
*/
func (a *Class5AuthorizationsAPIService) GetHoldsList(ctx context.Context, ppan string) ApiGetHoldsListRequest {
	return ApiGetHoldsListRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
//  @return HoldsDataArray
func (a *Class5AuthorizationsAPIService) GetHoldsListExecute(r ApiGetHoldsListRequest) (*HoldsDataArray, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *HoldsDataArray
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class5AuthorizationsAPIService.GetHoldsList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/{ppan}/holds"
