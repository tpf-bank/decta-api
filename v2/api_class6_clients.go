...
// Class6ClientsAPIService Class6ClientsAPI service
type Class6ClientsAPIService service

type ApiChangeDeliveryAddressRequest struct {
	ctx context.Context
	ApiService *Class6ClientsAPIService
	requestId *string
	tokenHeader *string
...
func (r ApiChangeDeliveryAddressRequest) RequestId(requestId string) ApiChangeDeliveryAddressRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiChangeDeliveryAddressRequest) TokenHeader(tokenHeader string) ApiChangeDeliveryAddressRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiChangeDeliveryAddressRequest) TokenSignature(tokenSignature string) ApiChangeDeliveryAddressRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiChangeDeliveryAddressRequest) DeliveryAddress(deliveryAddress DeliveryAddress) ApiChangeDeliveryAddressRequest {
	r.deliveryAddress = &deliveryAddress
	return r
}

func (r ApiChangeDeliveryAddressRequest) Execute() (*http.Response, error) {
	return r.ApiService.ChangeDeliveryAddressExecute(r)
}

/*
ChangeDeliveryAddress Change clients delivery address

The request allows users to change all or specific card delivery address fields, like address and shipment method. 
NB: Card delivery phone number can’t be changed and will be ignored by this request. To update it use other DAPI requests. 

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiChangeDeliveryAddressRequest
*/
func (a *Class6ClientsAPIService) ChangeDeliveryAddress(ctx context.Context, ppan string) ApiChangeDeliveryAddressRequest {
	return ApiChangeDeliveryAddressRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
func (a *Class6ClientsAPIService) ChangeDeliveryAddressExecute(r ApiChangeDeliveryAddressRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.ChangeDeliveryAddress")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/{ppan}/delivery-address"
	...
	// body params
	localVarPostBody = r.deliveryAddress
...
// Request ID (UUID format)
func (r ApiGetClientRequest) RequestId(requestId string) ApiGetClientRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetClientRequest) TokenHeader(tokenHeader string) ApiGetClientRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetClientRequest) TokenSignature(tokenSignature string) ApiGetClientRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiGetClientRequest) Execute() (*ClientInfo, *http.Response, error) {
	return r.ApiService.GetClientExecute(r)
}

/*
GetClient Search client by ID

The request allows users to receive clients data by using specific client id number

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clientId clientId is a unique client id number generated on the DECTA partner side. Maximum length 19 symbols
 @return ApiGetClientRequest
*/
func (a *Class6ClientsAPIService) GetClient(ctx context.Context, clientId string) ApiGetClientRequest {
	return ApiGetClientRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
...
// Execute executes the request
//  @return ClientInfo
func (a *Class6ClientsAPIService) GetClientExecute(r ApiGetClientRequest) (*ClientInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.GetClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/clients/{clientId}"
...
// Request ID (UUID format)
func (r ApiGetClientsRequest) RequestId(requestId string) ApiGetClientsRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetClientsRequest) TokenHeader(tokenHeader string) ApiGetClientsRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetClientsRequest) TokenSignature(tokenSignature string) ApiGetClientsRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// Number of clients
func (r ApiGetClientsRequest) Count(count int32) ApiGetClientsRequest {
	r.count = &count
	return r
}

// Client type
func (r ApiGetClientsRequest) ClientType(clientType string) ApiGetClientsRequest {
...
// Persons surname
func (r ApiGetClientsRequest) Surname(surname string) ApiGetClientsRequest {
	r.surname = &surname
	return r
}

// Business client company name
func (r ApiGetClientsRequest) CompanyName(companyName string) ApiGetClientsRequest {
	r.companyName = &companyName
	return r
}

// Business client company registration number
func (r ApiGetClientsRequest) RegistrationNumber(registrationNumber string) ApiGetClientsRequest {
	r.registrationNumber = &registrationNumber
	return r
}

// Start the ordered list from client with selected client id
func (r ApiGetClientsRequest) StartId(startId string) ApiGetClientsRequest {
	r.startId = &startId
	return r
}

func (r ApiGetClientsRequest) Execute() (*ClientInfoDataArray, *http.Response, error) {
	return r.ApiService.GetClientsExecute(r)
}

/*
GetClients Get client list

The request allows users to receive clients by selected parameters.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetClientsRequest
*/
func (a *Class6ClientsAPIService) GetClients(ctx context.Context) ApiGetClientsRequest {
	return ApiGetClientsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ClientInfoDataArray
func (a *Class6ClientsAPIService) GetClientsExecute(r ApiGetClientsRequest) (*ClientInfoDataArray, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ClientInfoDataArray
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.GetClients")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/clients"
	...
	if r.clientType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "clientType", r.clientType, "form", "")
	}
	if r.name != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "name", r.name, "form", "")
	}
	if r.surname != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "surname", r.surname, "form", "")
	}
	...
	if r.registrationNumber != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "registrationNumber", r.registrationNumber, "form", "")
	}
	if r.startId != nil {
...
type ApiUpdateClientAddressRequest struct {
	ctx context.Context
	ApiService *Class6ClientsAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiUpdateClientAddressRequest) RequestId(requestId string) ApiUpdateClientAddressRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiUpdateClientAddressRequest) TokenHeader(tokenHeader string) ApiUpdateClientAddressRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiUpdateClientAddressRequest) TokenSignature(tokenSignature string) ApiUpdateClientAddressRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiUpdateClientAddressRequest) ClientAddress(clientAddress ClientAddress) ApiUpdateClientAddressRequest {
	r.clientAddress = &clientAddress
	return r
}

func (r ApiUpdateClientAddressRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateClientAddressExecute(r)
}

/*
UpdateClientAddress Change client address fields

The request allows users to change selected clients current address fields.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clientId clientId is a unique client id number generated on the DECTA partner side. Maximum length 19 symbols
 @return ApiUpdateClientAddressRequest
*/
func (a *Class6ClientsAPIService) UpdateClientAddress(ctx context.Context, clientId string) ApiUpdateClientAddressRequest {
	return ApiUpdateClientAddressRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
...
// Execute executes the request
func (a *Class6ClientsAPIService) UpdateClientAddressExecute(r ApiUpdateClientAddressRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.UpdateClientAddress")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/clients/{clientId}/address"
	localVarPath = strings.Replace(localVarPath, "{"+"clientId"+"}", url.PathEscape(parameterValueToString(r.clientId, "clientId")), -1)
	...
	if strlen(r.clientId) < 0 {
		return nil, reportError("clientId must have at least 0 elements")
	}
	if strlen(r.clientId) > 19 {
		return nil, reportError("clientId must have less than 19 elements")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "token-signature", r.tokenSignature, "simple", "")
	// body params
	localVarPostBody = r.clientAddress
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
/*
UpdateEmail Change client email address

The request allows users to update client email address.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clientId clientId is a unique client \"id\" number generated on Decta partner side. Maximum length 19 symbols
 @return ApiUpdateEmailRequest
*/
func (a *Class6ClientsAPIService) UpdateEmail(ctx context.Context, clientId string) ApiUpdateEmailRequest {
	return ApiUpdateEmailRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
...
// Execute executes the request
func (a *Class6ClientsAPIService) UpdateEmailExecute(r ApiUpdateEmailRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.UpdateEmail")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdatePassphraseRequest struct {
	ctx context.Context
	ApiService *Class6ClientsAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiUpdatePassphraseRequest) RequestId(requestId string) ApiUpdatePassphraseRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiUpdatePassphraseRequest) TokenHeader(tokenHeader string) ApiUpdatePassphraseRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiUpdatePassphraseRequest) TokenSignature(tokenSignature string) ApiUpdatePassphraseRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiUpdatePassphraseRequest) PassphraseValue(passphraseValue PassphraseValue) ApiUpdatePassphraseRequest {
	r.passphraseValue = &passphraseValue
	return r
}

func (r ApiUpdatePassphraseRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdatePassphraseExecute(r)
}

/*
UpdatePassphrase Change card passphrase

The request allows users to change card passphrases by selecting PPAN. The passphrase is updated usually within seconds, but not longer than 10 minutes.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiUpdatePassphraseRequest
*/
func (a *Class6ClientsAPIService) UpdatePassphrase(ctx context.Context, ppan string) ApiUpdatePassphraseRequest {
	return ApiUpdatePassphraseRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
func (a *Class6ClientsAPIService) UpdatePassphraseExecute(r ApiUpdatePassphraseRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.UpdatePassphrase")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/cards/{ppan}/passphrase"
	localVarPath = strings.Replace(localVarPath, "{"+"ppan"+"}", url.PathEscape(parameterValueToString(r.ppan, "ppan")), -1)
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "token-signature", r.tokenSignature, "simple", "")
	// body params
	localVarPostBody = r.passphraseValue
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
// Request ID (UUID format)
func (r ApiUpdatePhoneRequest) RequestId(requestId string) ApiUpdatePhoneRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiUpdatePhoneRequest) TokenHeader(tokenHeader string) ApiUpdatePhoneRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiUpdatePhoneRequest) TokenSignature(tokenSignature string) ApiUpdatePhoneRequest {
	r.tokenSignature = &tokenSignature
	return r
}
...
func (r ApiUpdatePhoneRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdatePhoneExecute(r)
}

/*
UpdatePhone Change clients phone number

The request allows users to update clients mobile phone number.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param clientId clientId is a unique client \"id\" number generated on Decta partner side. Maximum length 19 symbols
 @return ApiUpdatePhoneRequest
*/
func (a *Class6ClientsAPIService) UpdatePhone(ctx context.Context, clientId string) ApiUpdatePhoneRequest {
	return ApiUpdatePhoneRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
...
// Execute executes the request
func (a *Class6ClientsAPIService) UpdatePhoneExecute(r ApiUpdatePhoneRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class6ClientsAPIService.UpdatePhone")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/clients/{clientId}/phone"
	localVarPath = strings.Replace(localVarPath, "{"+"clientId"+"}", url.PathEscape(parameterValueToString(r.clientId, "clientId")), -1)
