...
// Class7TokenAPIService Class7TokenAPI service
type Class7TokenAPIService service

type ApiChangeTokenStatusRequest struct {
	ctx context.Context
	ApiService *Class7TokenAPIService
	requestId *string
	tokenHeader *string
...
*/
func (a *Class7TokenAPIService) ChangeTokenStatus(ctx context.Context, tokenNumber string) ApiChangeTokenStatusRequest {
	return ApiChangeTokenStatusRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *Class7TokenAPIService) ChangeTokenStatusExecute(r ApiChangeTokenStatusRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class7TokenAPIService.ChangeTokenStatus")
	if err != nil {
...
*/
func (a *Class7TokenAPIService) GetApplePayReferenceData(ctx context.Context, ppan string) ApiGetApplePayReferenceDataRequest {
	return ApiGetApplePayReferenceDataRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
func (a *Class7TokenAPIService) GetApplePayReferenceDataExecute(r ApiGetApplePayReferenceDataRequest) (*PanReferenceData, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class7TokenAPIService.GetApplePayReferenceData")
	if err != nil {
...
*/
func (a *Class7TokenAPIService) GetGooglePayReferenceData(ctx context.Context, ppan string) ApiGetGooglePayReferenceDataRequest {
	return ApiGetGooglePayReferenceDataRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
//  @return Data
func (a *Class7TokenAPIService) GetGooglePayReferenceDataExecute(r ApiGetGooglePayReferenceDataRequest) (*Data, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class7TokenAPIService.GetGooglePayReferenceData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *Class7TokenAPIService) GetTokens(ctx context.Context, ppan string) ApiGetTokensRequest {
	return ApiGetTokensRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
//  @return TokenInfo
func (a *Class7TokenAPIService) GetTokensExecute(r ApiGetTokensRequest) (*TokenInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class7TokenAPIService.GetTokens")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
