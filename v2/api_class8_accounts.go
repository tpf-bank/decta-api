...
// Class8AccountsAPIService Class8AccountsAPI service
type Class8AccountsAPIService service

type ApiGetTransactionsQueueInfoRequest struct {
	ctx context.Context
	ApiService *Class8AccountsAPIService
	requestId *string
	tokenHeader *string
...
func (r ApiGetTransactionsQueueInfoRequest) RequestId(requestId string) ApiGetTransactionsQueueInfoRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetTransactionsQueueInfoRequest) TokenHeader(tokenHeader string) ApiGetTransactionsQueueInfoRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetTransactionsQueueInfoRequest) TokenSignature(tokenSignature string) ApiGetTransactionsQueueInfoRequest {
	r.tokenSignature = &tokenSignature
	return r
}

// ClientId is a unique client id number generated on the DECTA partner side. Length 19 symbols
func (r ApiGetTransactionsQueueInfoRequest) ClientId(clientId string) ApiGetTransactionsQueueInfoRequest {
	r.clientId = &clientId
	return r
}

func (r ApiGetTransactionsQueueInfoRequest) Execute() (*DataArray, *http.Response, error) {
	return r.ApiService.GetTransactionsQueueInfoExecute(r)
}

/*
GetTransactionsQueueInfo Get account transactions and commissions in queue

The request allows users to receive list of current transactions and commissions in queue. Transactions leaves queue once a day

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param cardAccount Card account identification number
 @return ApiGetTransactionsQueueInfoRequest
*/
func (a *Class8AccountsAPIService) GetTransactionsQueueInfo(ctx context.Context, cardAccount string) ApiGetTransactionsQueueInfoRequest {
	return ApiGetTransactionsQueueInfoRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return DataArray
func (a *Class8AccountsAPIService) GetTransactionsQueueInfoExecute(r ApiGetTransactionsQueueInfoRequest) (*DataArray, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DataArray
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class8AccountsAPIService.GetTransactionsQueueInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/accounts/{cardAccount}/transactions-queue"
	localVarPath = strings.Replace(localVarPath, "{"+"cardAccount"+"}", url.PathEscape(parameterValueToString(r.cardAccount, "cardAccount")), -1)
