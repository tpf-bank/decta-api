...
// Class9LimitsAPIService Class9LimitsAPI service
type Class9LimitsAPIService service

type ApiEditLimitsRequest struct {
	ctx context.Context
	ApiService *Class9LimitsAPIService
	requestId *string
	tokenHeader *string
...
func (r ApiEditLimitsRequest) RequestId(requestId string) ApiEditLimitsRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiEditLimitsRequest) TokenHeader(tokenHeader string) ApiEditLimitsRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiEditLimitsRequest) TokenSignature(tokenSignature string) ApiEditLimitsRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiEditLimitsRequest) LimitsData(limitsData LimitsData) ApiEditLimitsRequest {
	r.limitsData = &limitsData
	return r
}

func (r ApiEditLimitsRequest) Execute() (*http.Response, error) {
	return r.ApiService.EditLimitsExecute(r)
}

/*
EditLimits Change limits data by card

The request allows users to change card individual limits.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiEditLimitsRequest
*/
func (a *Class9LimitsAPIService) EditLimits(ctx context.Context) ApiEditLimitsRequest {
	return ApiEditLimitsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *Class9LimitsAPIService) EditLimitsExecute(r ApiEditLimitsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class9LimitsAPIService.EditLimits")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/limits/{ppan}"
...
// Request ID (UUID format)
func (r ApiGetLimitsRequest) RequestId(requestId string) ApiGetLimitsRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetLimitsRequest) TokenHeader(tokenHeader string) ApiGetLimitsRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetLimitsRequest) TokenSignature(tokenSignature string) ApiGetLimitsRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiGetLimitsRequest) Execute() (*LimitsData, *http.Response, error) {
	return r.ApiService.GetLimitsExecute(r)
}

/*
GetLimits Get limits data by card

The request allows users to get limits assigned to the card.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ppan Masked card number
 @return ApiGetLimitsRequest
*/
func (a *Class9LimitsAPIService) GetLimits(ctx context.Context, ppan string) ApiGetLimitsRequest {
	return ApiGetLimitsRequest{
		ApiService: a,
		ctx: ctx,
		ppan: ppan,
...
// Execute executes the request
//  @return LimitsData
func (a *Class9LimitsAPIService) GetLimitsExecute(r ApiGetLimitsRequest) (*LimitsData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *LimitsData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class9LimitsAPIService.GetLimits")
	if err != nil {
...
type ApiGetLimitsRefDataRequest struct {
	ctx context.Context
	ApiService *Class9LimitsAPIService
	requestId *string
	tokenHeader *string
...
// Request ID (UUID format)
func (r ApiGetLimitsRefDataRequest) RequestId(requestId string) ApiGetLimitsRefDataRequest {
	r.requestId = &requestId
	return r
}

// URL64Encoded without padding Header part of JWS token
func (r ApiGetLimitsRefDataRequest) TokenHeader(tokenHeader string) ApiGetLimitsRefDataRequest {
	r.tokenHeader = &tokenHeader
	return r
}

// URL64Encoded without padding Signature part of JWS
func (r ApiGetLimitsRefDataRequest) TokenSignature(tokenSignature string) ApiGetLimitsRefDataRequest {
	r.tokenSignature = &tokenSignature
	return r
}

func (r ApiGetLimitsRefDataRequest) Execute() (*LimitsData, *http.Response, error) {
	return r.ApiService.GetLimitsRefDataExecute(r)
}

/*
GetLimitsRefData Get limits reference data

The request allows users to get all available limits and description.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetLimitsRefDataRequest
*/
func (a *Class9LimitsAPIService) GetLimitsRefData(ctx context.Context) ApiGetLimitsRefDataRequest {
	return ApiGetLimitsRefDataRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return LimitsData
func (a *Class9LimitsAPIService) GetLimitsRefDataExecute(r ApiGetLimitsRefDataRequest) (*LimitsData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class9LimitsAPIService.GetLimitsRefData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/api/limits"
