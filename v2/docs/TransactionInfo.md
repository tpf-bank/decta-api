...
**Description** | Pointer to **string** | Payment details | [optional] 
**Ppan** | Pointer to **string** | A card pseudo number | [optional] 
**ReferenceData** | Pointer to **string** | Acquirer reference number | [optional] 
**ReferenceNumber** | Pointer to **string** | Retrieval reference number of related authorization request message | [optional] 
**SlipNumber** | Pointer to **string** | Internal transaction number | [optional] 
**ApprovalCode** | Pointer to **string** | Authorization code | [optional] 
**MsgType** | Pointer to **string** | Transaction message type | [optional] 
