...
// checks if the ApiErrorV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiErrorV2{}

// ApiErrorV2 ApiErrorV2
...
func (o ApiErrorV2) MarshalJSON() ([]byte, error) {
...
func (o ApiErrorV2) ToMap() (map[string]interface{}, error) {
...
type NullableApiErrorV2 struct {
	value *ApiErrorV2
	isSet bool
}

func (v NullableApiErrorV2) Get() *ApiErrorV2 {
	return v.value
}

func (v *NullableApiErrorV2) Set(val *ApiErrorV2) {
	v.value = val
	v.isSet = true
}

func (v NullableApiErrorV2) IsSet() bool {
	return v.isSet
}

func (v *NullableApiErrorV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiErrorV2(val *ApiErrorV2) *NullableApiErrorV2 {
	return &NullableApiErrorV2{value: val, isSet: true}
}

func (v NullableApiErrorV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiErrorV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
