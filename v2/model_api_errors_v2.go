...
// checks if the ApiErrorsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiErrorsV2{}

// ApiErrorsV2 ApiErrorsV2
type ApiErrorsV2 struct {
	// Errors list
	Errors []ApiErrorV2 `json:"errors,omitempty"`
}

// NewApiErrorsV2 instantiates a new ApiErrorsV2 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewApiErrorsV2() *ApiErrorsV2 {
	this := ApiErrorsV2{}
	return &this
}

// NewApiErrorsV2WithDefaults instantiates a new ApiErrorsV2 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewApiErrorsV2WithDefaults() *ApiErrorsV2 {
	this := ApiErrorsV2{}
	return &this
}

// GetErrors returns the Errors field value if set, zero value otherwise.
func (o *ApiErrorsV2) GetErrors() []ApiErrorV2 {
...
func (o *ApiErrorsV2) GetErrorsOk() ([]ApiErrorV2, bool) {
	if o == nil || IsNil(o.Errors) {
		return nil, false
	}
...
func (o *ApiErrorsV2) HasErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
// SetErrors gets a reference to the given []ApiErrorV2 and assigns it to the Errors field.
func (o *ApiErrorsV2) SetErrors(v []ApiErrorV2) {
	o.Errors = v
}

func (o ApiErrorsV2) MarshalJSON() ([]byte, error) {
...
func (o ApiErrorsV2) ToMap() (map[string]interface{}, error) {
...
type NullableApiErrorsV2 struct {
	value *ApiErrorsV2
	isSet bool
}

func (v NullableApiErrorsV2) Get() *ApiErrorsV2 {
	return v.value
}

func (v *NullableApiErrorsV2) Set(val *ApiErrorsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableApiErrorsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableApiErrorsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiErrorsV2(val *ApiErrorsV2) *NullableApiErrorsV2 {
	return &NullableApiErrorsV2{value: val, isSet: true}
}

func (v NullableApiErrorsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiErrorsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
