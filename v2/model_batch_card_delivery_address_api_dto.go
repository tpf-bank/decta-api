...
// checks if the BatchCardDeliveryAddressApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchCardDeliveryAddressApiDto{}

// BatchCardDeliveryAddressApiDto Produced card delivery address
type BatchCardDeliveryAddressApiDto struct {
	...
	// Name of a cardholder on an envelope
	Name *string `json:"name,omitempty"`
	// Surname of a cardholder on an envelope
	Surname *string `json:"surname,omitempty"`
	// Communication language (ISO 639-1)
	Language *string `json:"language,omitempty"`
}

type _BatchCardDeliveryAddressApiDto BatchCardDeliveryAddressApiDto
...
func NewBatchCardDeliveryAddressApiDto(country string, city string, street string) *BatchCardDeliveryAddressApiDto {
	this := BatchCardDeliveryAddressApiDto{}
...
// SetShipment gets a reference to the given string and assigns it to the Shipment field.
...
func (o BatchCardDeliveryAddressApiDto) MarshalJSON() ([]byte, error) {
...
func (o BatchCardDeliveryAddressApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *BatchCardDeliveryAddressApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchCardDeliveryAddressApiDto := _BatchCardDeliveryAddressApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchCardDeliveryAddressApiDto)

	if err != nil {
		return err
	}

	*o = BatchCardDeliveryAddressApiDto(varBatchCardDeliveryAddressApiDto)

	return err
}

type NullableBatchCardDeliveryAddressApiDto struct {
	value *BatchCardDeliveryAddressApiDto
	isSet bool
}

func (v NullableBatchCardDeliveryAddressApiDto) Get() *BatchCardDeliveryAddressApiDto {
	return v.value
}

func (v *NullableBatchCardDeliveryAddressApiDto) Set(val *BatchCardDeliveryAddressApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchCardDeliveryAddressApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchCardDeliveryAddressApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchCardDeliveryAddressApiDto(val *BatchCardDeliveryAddressApiDto) *NullableBatchCardDeliveryAddressApiDto {
	return &NullableBatchCardDeliveryAddressApiDto{value: val, isSet: true}
}

func (v NullableBatchCardDeliveryAddressApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchCardDeliveryAddressApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
