...
// checks if the BatchCardPreferencesApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchCardPreferencesApiDto{}

// BatchCardPreferencesApiDto Ordering card preferences
type BatchCardPreferencesApiDto struct {
	...
	DeliveryAddress BatchCardDeliveryAddressApiDto `json:"deliveryAddress"`
	// Free field for custom use
	UserDefinedField12 string `json:"userDefinedField12"`
}

type _BatchCardPreferencesApiDto BatchCardPreferencesApiDto
...
func NewBatchCardPreferencesApiDto(productCode string, currencies string, deliveryAddress BatchCardDeliveryAddressApiDto, userDefinedField12 string) *BatchCardPreferencesApiDto {
	this := BatchCardPreferencesApiDto{}
...
func (o *BatchCardPreferencesApiDto) GetDeliveryAddress() BatchCardDeliveryAddressApiDto {
	if o == nil {
		var ret BatchCardDeliveryAddressApiDto
		return ret
	}
...
// GetUserDefinedField12 returns the UserDefinedField12 field value
...
// GetUserDefinedField12Ok returns a tuple with the UserDefinedField12 field value
// and a boolean to check if the value has been set.
...
// SetUserDefinedField12 sets field value
func (o *BatchCardPreferencesApiDto) SetUserDefinedField12(v string) {
	o.UserDefinedField12 = v
}

func (o BatchCardPreferencesApiDto) MarshalJSON() ([]byte, error) {
...
func (o BatchCardPreferencesApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *BatchCardPreferencesApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchCardPreferencesApiDto := _BatchCardPreferencesApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchCardPreferencesApiDto)

	if err != nil {
		return err
	}

	*o = BatchCardPreferencesApiDto(varBatchCardPreferencesApiDto)

	return err
}

type NullableBatchCardPreferencesApiDto struct {
	value *BatchCardPreferencesApiDto
	isSet bool
}

func (v NullableBatchCardPreferencesApiDto) Get() *BatchCardPreferencesApiDto {
	return v.value
}

func (v *NullableBatchCardPreferencesApiDto) Set(val *BatchCardPreferencesApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchCardPreferencesApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchCardPreferencesApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchCardPreferencesApiDto(val *BatchCardPreferencesApiDto) *NullableBatchCardPreferencesApiDto {
	return &NullableBatchCardPreferencesApiDto{value: val, isSet: true}
}

func (v NullableBatchCardPreferencesApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchCardPreferencesApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
