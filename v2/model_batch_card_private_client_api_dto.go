...
// checks if the BatchCardPrivateClientApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchCardPrivateClientApiDto{}

// BatchCardPrivateClientApiDto Provide requested information to batch order gift card
type BatchCardPrivateClientApiDto struct {
	// Person name
...
type _BatchCardPrivateClientApiDto BatchCardPrivateClientApiDto

// NewBatchCardPrivateClientApiDto instantiates a new BatchCardPrivateClientApiDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBatchCardPrivateClientApiDto(name string, surname string, maidenName string) *BatchCardPrivateClientApiDto {
	this := BatchCardPrivateClientApiDto{}
	this.Name = name
...
// NewBatchCardPrivateClientApiDtoWithDefaults instantiates a new BatchCardPrivateClientApiDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBatchCardPrivateClientApiDtoWithDefaults() *BatchCardPrivateClientApiDto {
	this := BatchCardPrivateClientApiDto{}
	return &this
}

// GetName returns the Name field value
func (o *BatchCardPrivateClientApiDto) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *BatchCardPrivateClientApiDto) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *BatchCardPrivateClientApiDto) SetName(v string) {
	o.Name = v
}

// GetSurname returns the Surname field value
func (o *BatchCardPrivateClientApiDto) GetSurname() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BatchCardPrivateClientApiDto) GetSurnameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BatchCardPrivateClientApiDto) SetSurname(v string) {
	o.Surname = v
}

// GetMaidenName returns the MaidenName field value
func (o *BatchCardPrivateClientApiDto) GetMaidenName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetMaidenNameOk returns a tuple with the MaidenName field value
// and a boolean to check if the value has been set.
func (o *BatchCardPrivateClientApiDto) GetMaidenNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// SetMaidenName sets field value
func (o *BatchCardPrivateClientApiDto) SetMaidenName(v string) {
	o.MaidenName = v
}

func (o BatchCardPrivateClientApiDto) MarshalJSON() ([]byte, error) {
...
func (o BatchCardPrivateClientApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *BatchCardPrivateClientApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchCardPrivateClientApiDto := _BatchCardPrivateClientApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchCardPrivateClientApiDto)

	if err != nil {
		return err
	}

	*o = BatchCardPrivateClientApiDto(varBatchCardPrivateClientApiDto)

	return err
}

type NullableBatchCardPrivateClientApiDto struct {
	value *BatchCardPrivateClientApiDto
	isSet bool
}

func (v NullableBatchCardPrivateClientApiDto) Get() *BatchCardPrivateClientApiDto {
	return v.value
}

func (v *NullableBatchCardPrivateClientApiDto) Set(val *BatchCardPrivateClientApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchCardPrivateClientApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchCardPrivateClientApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchCardPrivateClientApiDto(val *BatchCardPrivateClientApiDto) *NullableBatchCardPrivateClientApiDto {
	return &NullableBatchCardPrivateClientApiDto{value: val, isSet: true}
}

func (v NullableBatchCardPrivateClientApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchCardPrivateClientApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
