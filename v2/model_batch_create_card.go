...
// checks if the BatchCreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchCreateCard{}

// BatchCreateCard Batch card create object
type BatchCreateCard struct {
	// Number of cards to create
	Count string `json:"count"`
	Template BatchCreateCardTemplateApiDto `json:"template"`
}

type _BatchCreateCard BatchCreateCard
...
func (o *BatchCreateCard) GetTemplate() BatchCreateCardTemplateApiDto {
	if o == nil {
		var ret BatchCreateCardTemplateApiDto
		return ret
	}
...
func (o BatchCreateCard) MarshalJSON() ([]byte, error) {
...
func (o BatchCreateCard) ToMap() (map[string]interface{}, error) {
...
func (o *BatchCreateCard) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchCreateCard := _BatchCreateCard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchCreateCard)

	if err != nil {
		return err
	}

	*o = BatchCreateCard(varBatchCreateCard)

	return err
}

type NullableBatchCreateCard struct {
	value *BatchCreateCard
	isSet bool
}

func (v NullableBatchCreateCard) Get() *BatchCreateCard {
	return v.value
}

func (v *NullableBatchCreateCard) Set(val *BatchCreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchCreateCard(val *BatchCreateCard) *NullableBatchCreateCard {
	return &NullableBatchCreateCard{value: val, isSet: true}
}

func (v NullableBatchCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
