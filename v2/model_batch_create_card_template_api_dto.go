...
// checks if the BatchCreateCardTemplateApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchCreateCardTemplateApiDto{}

// BatchCreateCardTemplateApiDto Provide requested information to batch order gift card
type BatchCreateCardTemplateApiDto struct {
	PrivateClient BatchCardPrivateClientApiDto `json:"privateClient"`
	Card BatchCardPreferencesApiDto `json:"card"`
}

type _BatchCreateCardTemplateApiDto BatchCreateCardTemplateApiDto
...
func NewBatchCreateCardTemplateApiDto(privateClient BatchCardPrivateClientApiDto, card BatchCardPreferencesApiDto) *BatchCreateCardTemplateApiDto {
	this := BatchCreateCardTemplateApiDto{}
...
// GetPrivateClient returns the PrivateClient field value
func (o *BatchCreateCardTemplateApiDto) GetPrivateClient() BatchCardPrivateClientApiDto {
	if o == nil {
		var ret BatchCardPrivateClientApiDto
		return ret
	}
...
// GetPrivateClientOk returns a tuple with the PrivateClient field value
...
// SetPrivateClient sets field value
...
func (o *BatchCreateCardTemplateApiDto) GetCard() BatchCardPreferencesApiDto {
	if o == nil {
		var ret BatchCardPreferencesApiDto
		return ret
	}
...
func (o BatchCreateCardTemplateApiDto) MarshalJSON() ([]byte, error) {
...
func (o BatchCreateCardTemplateApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *BatchCreateCardTemplateApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchCreateCardTemplateApiDto := _BatchCreateCardTemplateApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchCreateCardTemplateApiDto)

	if err != nil {
		return err
	}

	*o = BatchCreateCardTemplateApiDto(varBatchCreateCardTemplateApiDto)

	return err
}

type NullableBatchCreateCardTemplateApiDto struct {
	value *BatchCreateCardTemplateApiDto
	isSet bool
}

func (v NullableBatchCreateCardTemplateApiDto) Get() *BatchCreateCardTemplateApiDto {
	return v.value
}

func (v *NullableBatchCreateCardTemplateApiDto) Set(val *BatchCreateCardTemplateApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchCreateCardTemplateApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchCreateCardTemplateApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchCreateCardTemplateApiDto(val *BatchCreateCardTemplateApiDto) *NullableBatchCreateCardTemplateApiDto {
	return &NullableBatchCreateCardTemplateApiDto{value: val, isSet: true}
}

func (v NullableBatchCreateCardTemplateApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchCreateCardTemplateApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
