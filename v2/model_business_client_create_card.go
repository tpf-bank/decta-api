...
// checks if the BusinessClientCreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessClientCreateCard{}

// BusinessClientCreateCard Provide requested information about business client
type BusinessClientCreateCard struct {
	...
	Address *AddressCreateCard `json:"address,omitempty"`
	Contact *ContactCreateCard `json:"contact,omitempty"`
}

type _BusinessClientCreateCard BusinessClientCreateCard
...
// SetAddress gets a reference to the given AddressCreateCard and assigns it to the Address field.
...
// SetContact gets a reference to the given ContactCreateCard and assigns it to the Contact field.
func (o *BusinessClientCreateCard) SetContact(v ContactCreateCard) {
	o.Contact = &v
}

func (o BusinessClientCreateCard) MarshalJSON() ([]byte, error) {
...
func (o BusinessClientCreateCard) ToMap() (map[string]interface{}, error) {
...
func (o *BusinessClientCreateCard) UnmarshalJSON(data []byte) (err error) {
	...
	varBusinessClientCreateCard := _BusinessClientCreateCard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBusinessClientCreateCard)

	if err != nil {
		return err
	}

	*o = BusinessClientCreateCard(varBusinessClientCreateCard)

	return err
}

type NullableBusinessClientCreateCard struct {
	value *BusinessClientCreateCard
	isSet bool
}

func (v NullableBusinessClientCreateCard) Get() *BusinessClientCreateCard {
	return v.value
}

func (v *NullableBusinessClientCreateCard) Set(val *BusinessClientCreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessClientCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessClientCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessClientCreateCard(val *BusinessClientCreateCard) *NullableBusinessClientCreateCard {
	return &NullableBusinessClientCreateCard{value: val, isSet: true}
}

func (v NullableBusinessClientCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessClientCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
