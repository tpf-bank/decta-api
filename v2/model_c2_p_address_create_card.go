...
// checks if the C2PAddressCreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &C2PAddressCreateCard{}

// C2PAddressCreateCard struct for C2PAddressCreateCard
type C2PAddressCreateCard struct {
...
func (o C2PAddressCreateCard) MarshalJSON() ([]byte, error) {
...
func (o C2PAddressCreateCard) ToMap() (map[string]interface{}, error) {
...
type NullableC2PAddressCreateCard struct {
	value *C2PAddressCreateCard
	isSet bool
}

func (v NullableC2PAddressCreateCard) Get() *C2PAddressCreateCard {
	return v.value
}

func (v *NullableC2PAddressCreateCard) Set(val *C2PAddressCreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableC2PAddressCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableC2PAddressCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableC2PAddressCreateCard(val *C2PAddressCreateCard) *NullableC2PAddressCreateCard {
	return &NullableC2PAddressCreateCard{value: val, isSet: true}
}

func (v NullableC2PAddressCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableC2PAddressCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
