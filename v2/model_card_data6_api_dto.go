...
// checks if the CardData6ApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardData6ApiDto{}

// CardData6ApiDto Card Data 6 info
type CardData6ApiDto struct {
	// Card Data
	CardData string `json:"cardData"`
}

type _CardData6ApiDto CardData6ApiDto

// NewCardData6ApiDto instantiates a new CardData6ApiDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCardData6ApiDto(cardData string) *CardData6ApiDto {
	this := CardData6ApiDto{}
	this.CardData = cardData
	return &this
}

// NewCardData6ApiDtoWithDefaults instantiates a new CardData6ApiDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCardData6ApiDtoWithDefaults() *CardData6ApiDto {
	this := CardData6ApiDto{}
	return &this
}

// GetCardData returns the CardData field value
func (o *CardData6ApiDto) GetCardData() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetCardDataOk returns a tuple with the CardData field value
// and a boolean to check if the value has been set.
func (o *CardData6ApiDto) GetCardDataOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CardData, true
}

// SetCardData sets field value
func (o *CardData6ApiDto) SetCardData(v string) {
	o.CardData = v
}

func (o CardData6ApiDto) MarshalJSON() ([]byte, error) {
...
func (o CardData6ApiDto) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cardData"] = o.CardData
	return toSerialize, nil
}

func (o *CardData6ApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCardData6ApiDto := _CardData6ApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCardData6ApiDto)

	if err != nil {
		return err
	}

	*o = CardData6ApiDto(varCardData6ApiDto)

	return err
}

type NullableCardData6ApiDto struct {
	value *CardData6ApiDto
	isSet bool
}

func (v NullableCardData6ApiDto) Get() *CardData6ApiDto {
	return v.value
}

func (v *NullableCardData6ApiDto) Set(val *CardData6ApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCardData6ApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCardData6ApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardData6ApiDto(val *CardData6ApiDto) *NullableCardData6ApiDto {
	return &NullableCardData6ApiDto{value: val, isSet: true}
}

func (v NullableCardData6ApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardData6ApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
