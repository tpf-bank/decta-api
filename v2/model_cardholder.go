...
// checks if the Cardholder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Cardholder{}

// Cardholder Provide requested information about cardholder
type Cardholder struct {
	...
	// Position of a cardholder in a company - for payroll and Business card issuing 
...
func (o Cardholder) MarshalJSON() ([]byte, error) {
...
func (o Cardholder) ToMap() (map[string]interface{}, error) {
...
type NullableCardholder struct {
	value *Cardholder
	isSet bool
}

func (v NullableCardholder) Get() *Cardholder {
	return v.value
}

func (v *NullableCardholder) Set(val *Cardholder) {
	v.value = val
	v.isSet = true
}

func (v NullableCardholder) IsSet() bool {
	return v.isSet
}

func (v *NullableCardholder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardholder(val *Cardholder) *NullableCardholder {
	return &NullableCardholder{value: val, isSet: true}
}

func (v NullableCardholder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardholder) UnmarshalJSON(src []byte) error {
	v.isSet = true
