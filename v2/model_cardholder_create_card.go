...
// checks if the CardholderCreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardholderCreateCard{}

// CardholderCreateCard Provide requested information about cardholder
type CardholderCreateCard struct {
	...
	CurrentAddress *AddressCreateCard `json:"currentAddress,omitempty"`
...
// SetCurrentAddress gets a reference to the given AddressCreateCard and assigns it to the CurrentAddress field.
...
func (o CardholderCreateCard) MarshalJSON() ([]byte, error) {
...
func (o CardholderCreateCard) ToMap() (map[string]interface{}, error) {
...
type NullableCardholderCreateCard struct {
	value *CardholderCreateCard
	isSet bool
}

func (v NullableCardholderCreateCard) Get() *CardholderCreateCard {
	return v.value
}

func (v *NullableCardholderCreateCard) Set(val *CardholderCreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableCardholderCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableCardholderCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardholderCreateCard(val *CardholderCreateCard) *NullableCardholderCreateCard {
	return &NullableCardholderCreateCard{value: val, isSet: true}
}

func (v NullableCardholderCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardholderCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
