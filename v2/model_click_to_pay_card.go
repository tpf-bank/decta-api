...
// checks if the ClickToPayCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClickToPayCard{}

// ClickToPayCard struct for ClickToPayCard
type ClickToPayCard struct {
...
func (o ClickToPayCard) MarshalJSON() ([]byte, error) {
...
func (o ClickToPayCard) ToMap() (map[string]interface{}, error) {
...
type NullableClickToPayCard struct {
	value *ClickToPayCard
	isSet bool
}

func (v NullableClickToPayCard) Get() *ClickToPayCard {
	return v.value
}

func (v *NullableClickToPayCard) Set(val *ClickToPayCard) {
	v.value = val
	v.isSet = true
}

func (v NullableClickToPayCard) IsSet() bool {
	return v.isSet
}

func (v *NullableClickToPayCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClickToPayCard(val *ClickToPayCard) *NullableClickToPayCard {
	return &NullableClickToPayCard{value: val, isSet: true}
}

func (v NullableClickToPayCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClickToPayCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
