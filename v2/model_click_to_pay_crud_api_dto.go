...
// checks if the ClickToPayCrudApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClickToPayCrudApiDto{}

// ClickToPayCrudApiDto Profile
type ClickToPayCrudApiDto struct {
	Profile *ClickToPayProfileApiDto `json:"profile,omitempty"`
}

// NewClickToPayCrudApiDto instantiates a new ClickToPayCrudApiDto object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewClickToPayCrudApiDto() *ClickToPayCrudApiDto {
	this := ClickToPayCrudApiDto{}
	return &this
}

// NewClickToPayCrudApiDtoWithDefaults instantiates a new ClickToPayCrudApiDto object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewClickToPayCrudApiDtoWithDefaults() *ClickToPayCrudApiDto {
	this := ClickToPayCrudApiDto{}
	return &this
}

// GetProfile returns the Profile field value if set, zero value otherwise.
func (o *ClickToPayCrudApiDto) GetProfile() ClickToPayProfileApiDto {
	if o == nil || IsNil(o.Profile) {
		var ret ClickToPayProfileApiDto
		return ret
	}
	return *o.Profile
}
...
func (o *ClickToPayCrudApiDto) GetProfileOk() (*ClickToPayProfileApiDto, bool) {
	if o == nil || IsNil(o.Profile) {
		return nil, false
	}
...
func (o *ClickToPayCrudApiDto) HasProfile() bool {
	if o != nil && !IsNil(o.Profile) {
		return true
	}
...
// SetProfile gets a reference to the given ClickToPayProfileApiDto and assigns it to the Profile field.
func (o *ClickToPayCrudApiDto) SetProfile(v ClickToPayProfileApiDto) {
	o.Profile = &v
}

func (o ClickToPayCrudApiDto) MarshalJSON() ([]byte, error) {
...
func (o ClickToPayCrudApiDto) ToMap() (map[string]interface{}, error) {
...
type NullableClickToPayCrudApiDto struct {
	value *ClickToPayCrudApiDto
	isSet bool
}

func (v NullableClickToPayCrudApiDto) Get() *ClickToPayCrudApiDto {
	return v.value
}

func (v *NullableClickToPayCrudApiDto) Set(val *ClickToPayCrudApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableClickToPayCrudApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableClickToPayCrudApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClickToPayCrudApiDto(val *ClickToPayCrudApiDto) *NullableClickToPayCrudApiDto {
	return &NullableClickToPayCrudApiDto{value: val, isSet: true}
}

func (v NullableClickToPayCrudApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClickToPayCrudApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
