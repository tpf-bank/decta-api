...
// checks if the ClickToPayGetData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClickToPayGetData{}

// ClickToPayGetData struct for ClickToPayGetData
type ClickToPayGetData struct {
	Profile ClickToPayProfileCard `json:"profile"`
}

type _ClickToPayGetData ClickToPayGetData

// NewClickToPayGetData instantiates a new ClickToPayGetData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewClickToPayGetData(profile ClickToPayProfileCard) *ClickToPayGetData {
	this := ClickToPayGetData{}
	this.Profile = profile
	return &this
}

// NewClickToPayGetDataWithDefaults instantiates a new ClickToPayGetData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewClickToPayGetDataWithDefaults() *ClickToPayGetData {
	this := ClickToPayGetData{}
	return &this
}

// GetProfile returns the Profile field value
func (o *ClickToPayGetData) GetProfile() ClickToPayProfileCard {
	if o == nil {
		var ret ClickToPayProfileCard
		return ret
	}
...
func (o *ClickToPayGetData) GetProfileOk() (*ClickToPayProfileCard, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ClickToPayGetData) SetProfile(v ClickToPayProfileCard) {
	o.Profile = v
}

func (o ClickToPayGetData) MarshalJSON() ([]byte, error) {
...
func (o ClickToPayGetData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["profile"] = o.Profile
	return toSerialize, nil
}

func (o *ClickToPayGetData) UnmarshalJSON(data []byte) (err error) {
	...
	varClickToPayGetData := _ClickToPayGetData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClickToPayGetData)

	if err != nil {
		return err
	}

	*o = ClickToPayGetData(varClickToPayGetData)

	return err
}

type NullableClickToPayGetData struct {
	value *ClickToPayGetData
	isSet bool
}

func (v NullableClickToPayGetData) Get() *ClickToPayGetData {
	return v.value
}

func (v *NullableClickToPayGetData) Set(val *ClickToPayGetData) {
	v.value = val
	v.isSet = true
}

func (v NullableClickToPayGetData) IsSet() bool {
	return v.isSet
}

func (v *NullableClickToPayGetData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClickToPayGetData(val *ClickToPayGetData) *NullableClickToPayGetData {
	return &NullableClickToPayGetData{value: val, isSet: true}
}

func (v NullableClickToPayGetData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClickToPayGetData) UnmarshalJSON(src []byte) error {
	v.isSet = true
