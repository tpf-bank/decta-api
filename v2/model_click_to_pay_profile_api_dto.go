...
// checks if the ClickToPayProfileApiDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClickToPayProfileApiDto{}

// ClickToPayProfileApiDto struct for ClickToPayProfileApiDto
type ClickToPayProfileApiDto struct {
	...
	Address *C2PAddressCreateCard `json:"address,omitempty"`
}

type _ClickToPayProfileApiDto ClickToPayProfileApiDto
...
// SetAddress gets a reference to the given C2PAddressCreateCard and assigns it to the Address field.
func (o *ClickToPayProfileApiDto) SetAddress(v C2PAddressCreateCard) {
	o.Address = &v
}

func (o ClickToPayProfileApiDto) MarshalJSON() ([]byte, error) {
...
func (o ClickToPayProfileApiDto) ToMap() (map[string]interface{}, error) {
...
func (o *ClickToPayProfileApiDto) UnmarshalJSON(data []byte) (err error) {
	...
	varClickToPayProfileApiDto := _ClickToPayProfileApiDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClickToPayProfileApiDto)

	if err != nil {
		return err
	}

	*o = ClickToPayProfileApiDto(varClickToPayProfileApiDto)

	return err
}

type NullableClickToPayProfileApiDto struct {
	value *ClickToPayProfileApiDto
	isSet bool
}

func (v NullableClickToPayProfileApiDto) Get() *ClickToPayProfileApiDto {
	return v.value
}

func (v *NullableClickToPayProfileApiDto) Set(val *ClickToPayProfileApiDto) {
	v.value = val
	v.isSet = true
}

func (v NullableClickToPayProfileApiDto) IsSet() bool {
	return v.isSet
}

func (v *NullableClickToPayProfileApiDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClickToPayProfileApiDto(val *ClickToPayProfileApiDto) *NullableClickToPayProfileApiDto {
	return &NullableClickToPayProfileApiDto{value: val, isSet: true}
}

func (v NullableClickToPayProfileApiDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClickToPayProfileApiDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
