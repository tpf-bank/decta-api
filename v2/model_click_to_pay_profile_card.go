...
// checks if the ClickToPayProfileCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClickToPayProfileCard{}

// ClickToPayProfileCard Profile
type ClickToPayProfileCard struct {
	...
	Cards []ClickToPayCard `json:"cards,omitempty"`
}

type _ClickToPayProfileCard ClickToPayProfileCard
...
// SetCards gets a reference to the given []ClickToPayCard and assigns it to the Cards field.
func (o *ClickToPayProfileCard) SetCards(v []ClickToPayCard) {
	o.Cards = v
}

func (o ClickToPayProfileCard) MarshalJSON() ([]byte, error) {
...
func (o ClickToPayProfileCard) ToMap() (map[string]interface{}, error) {
...
func (o *ClickToPayProfileCard) UnmarshalJSON(data []byte) (err error) {
	...
	varClickToPayProfileCard := _ClickToPayProfileCard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClickToPayProfileCard)

	if err != nil {
		return err
	}

	*o = ClickToPayProfileCard(varClickToPayProfileCard)

	return err
}

type NullableClickToPayProfileCard struct {
	value *ClickToPayProfileCard
	isSet bool
}

func (v NullableClickToPayProfileCard) Get() *ClickToPayProfileCard {
	return v.value
}

func (v *NullableClickToPayProfileCard) Set(val *ClickToPayProfileCard) {
	v.value = val
	v.isSet = true
}

func (v NullableClickToPayProfileCard) IsSet() bool {
	return v.isSet
}

func (v *NullableClickToPayProfileCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClickToPayProfileCard(val *ClickToPayProfileCard) *NullableClickToPayProfileCard {
	return &NullableClickToPayProfileCard{value: val, isSet: true}
}

func (v NullableClickToPayProfileCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClickToPayProfileCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
