...
type ClientInfo struct {
	// Client uniq identification number. Deprecated, use id instead
	// Deprecated
	UniqId *string `json:"uniqId,omitempty"`
	// id
	Id *string `json:"id,omitempty"`
	// Client type. Private or Business
	Type *string `json:"type,omitempty"`
	PrivateClientInfo *PrivateClientInfo `json:"privateClientInfo,omitempty"`
	BusinessClientInfo *BusinessClientInfo `json:"businessClientInfo,omitempty"`
}
...
// GetPrivateClientInfo returns the PrivateClientInfo field value if set, zero value otherwise.
func (o *ClientInfo) GetPrivateClientInfo() PrivateClientInfo {
	if o == nil || IsNil(o.PrivateClientInfo) {
		var ret PrivateClientInfo
		return ret
	}
	return *o.PrivateClientInfo
}

// GetPrivateClientInfoOk returns a tuple with the PrivateClientInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClientInfo) GetPrivateClientInfoOk() (*PrivateClientInfo, bool) {
	if o == nil || IsNil(o.PrivateClientInfo) {
		return nil, false
	}
	return o.PrivateClientInfo, true
}
...
// SetPrivateClientInfo gets a reference to the given PrivateClientInfo and assigns it to the PrivateClientInfo field.
func (o *ClientInfo) SetPrivateClientInfo(v PrivateClientInfo) {
	o.PrivateClientInfo = &v
}

// GetBusinessClientInfo returns the BusinessClientInfo field value if set, zero value otherwise.
func (o *ClientInfo) GetBusinessClientInfo() BusinessClientInfo {
	if o == nil || IsNil(o.BusinessClientInfo) {
		var ret BusinessClientInfo
		return ret
	}
	return *o.BusinessClientInfo
}

// GetBusinessClientInfoOk returns a tuple with the BusinessClientInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClientInfo) GetBusinessClientInfoOk() (*BusinessClientInfo, bool) {
	if o == nil || IsNil(o.BusinessClientInfo) {
		return nil, false
	}
	return o.BusinessClientInfo, true
}
...
// SetBusinessClientInfo gets a reference to the given BusinessClientInfo and assigns it to the BusinessClientInfo field.
func (o *ClientInfo) SetBusinessClientInfo(v BusinessClientInfo) {
	o.BusinessClientInfo = &v
}
...
func (o ClientInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PrivateClientInfo) {
		toSerialize["privateClientInfo"] = o.PrivateClientInfo
	}
	if !IsNil(o.BusinessClientInfo) {
		toSerialize["businessClientInfo"] = o.BusinessClientInfo
	}
