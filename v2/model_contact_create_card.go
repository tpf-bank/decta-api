...
// checks if the ContactCreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactCreateCard{}

// ContactCreateCard Provide requested information about client main/supplement contact person
type ContactCreateCard struct {
	// Person name <i style=\"color:grey\">[name length + surname length - max 24 symbols]<i/>
	Name *string `json:"name,omitempty"`
	// Person surname <i style=\"color:grey\">[name length + surname length - max 24 symbols]<i/>
...
func (o ContactCreateCard) MarshalJSON() ([]byte, error) {
...
func (o ContactCreateCard) ToMap() (map[string]interface{}, error) {
...
type NullableContactCreateCard struct {
	value *ContactCreateCard
	isSet bool
}

func (v NullableContactCreateCard) Get() *ContactCreateCard {
	return v.value
}

func (v *NullableContactCreateCard) Set(val *ContactCreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableContactCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableContactCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactCreateCard(val *ContactCreateCard) *NullableContactCreateCard {
	return &NullableContactCreateCard{value: val, isSet: true}
}

func (v NullableContactCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
