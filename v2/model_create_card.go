...
// checks if the CreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCard{}

// CreateCard Detailed information for the card order object
type CreateCard struct {
	PrivateClient *PrivateClientCreateCard `json:"privateClient,omitempty"`
	BusinessClient *BusinessClientCreateCard `json:"businessClient,omitempty"`
	Card CardPreferencesCreateCard `json:"card"`
}

type _CreateCard CreateCard
...
// GetPrivateClient returns the PrivateClient field value if set, zero value otherwise.
func (o *CreateCard) GetPrivateClient() PrivateClientCreateCard {
	if o == nil || IsNil(o.PrivateClient) {
		var ret PrivateClientCreateCard
		return ret
	}
	return *o.PrivateClient
}

// GetPrivateClientOk returns a tuple with the PrivateClient field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCard) GetPrivateClientOk() (*PrivateClientCreateCard, bool) {
	if o == nil || IsNil(o.PrivateClient) {
		return nil, false
	}
	return o.PrivateClient, true
}
...
// SetPrivateClient gets a reference to the given PrivateClientCreateCard and assigns it to the PrivateClient field.
func (o *CreateCard) SetPrivateClient(v PrivateClientCreateCard) {
	o.PrivateClient = &v
}

// GetBusinessClient returns the BusinessClient field value if set, zero value otherwise.
func (o *CreateCard) GetBusinessClient() BusinessClientCreateCard {
	if o == nil || IsNil(o.BusinessClient) {
		var ret BusinessClientCreateCard
		return ret
	}
	return *o.BusinessClient
}

// GetBusinessClientOk returns a tuple with the BusinessClient field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateCard) GetBusinessClientOk() (*BusinessClientCreateCard, bool) {
	if o == nil || IsNil(o.BusinessClient) {
		return nil, false
	}
	return o.BusinessClient, true
}
...
// SetBusinessClient gets a reference to the given BusinessClientCreateCard and assigns it to the BusinessClient field.
...
func (o *CreateCard) GetCard() CardPreferencesCreateCard {
	if o == nil {
		var ret CardPreferencesCreateCard
		return ret
	}
...
func (o CreateCard) MarshalJSON() ([]byte, error) {
...
func (o CreateCard) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PrivateClient) {
		toSerialize["privateClient"] = o.PrivateClient
	}
	if !IsNil(o.BusinessClient) {
		toSerialize["businessClient"] = o.BusinessClient
	}
	toSerialize["card"] = o.Card
	return toSerialize, nil
}

func (o *CreateCard) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCard := _CreateCard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCard)

	if err != nil {
		return err
	}

	*o = CreateCard(varCreateCard)

	return err
}

type NullableCreateCard struct {
	value *CreateCard
	isSet bool
}

func (v NullableCreateCard) Get() *CreateCard {
	return v.value
}

func (v *NullableCreateCard) Set(val *CreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCard(val *CreateCard) *NullableCreateCard {
	return &NullableCreateCard{value: val, isSet: true}
}

func (v NullableCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
