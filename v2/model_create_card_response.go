...
// checks if the CreateCardResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCardResponse{}

// CreateCardResponse Created card information
...
func (o CreateCardResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateCardResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCardResponse struct {
	value *CreateCardResponse
	isSet bool
}

func (v NullableCreateCardResponse) Get() *CreateCardResponse {
	return v.value
}

func (v *NullableCreateCardResponse) Set(val *CreateCardResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCardResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCardResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCardResponse(val *CreateCardResponse) *NullableCreateCardResponse {
	return &NullableCreateCardResponse{value: val, isSet: true}
}

func (v NullableCreateCardResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCardResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
