...
// checks if the DeliveryAddressCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeliveryAddressCreate{}

// DeliveryAddressCreate Produced card delivery address
...
type _DeliveryAddressCreate DeliveryAddressCreate
...
func (o DeliveryAddressCreate) MarshalJSON() ([]byte, error) {
...
func (o DeliveryAddressCreate) ToMap() (map[string]interface{}, error) {
...
func (o *DeliveryAddressCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varDeliveryAddressCreate := _DeliveryAddressCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeliveryAddressCreate)

	if err != nil {
		return err
	}

	*o = DeliveryAddressCreate(varDeliveryAddressCreate)

	return err
}

type NullableDeliveryAddressCreate struct {
	value *DeliveryAddressCreate
	isSet bool
}

func (v NullableDeliveryAddressCreate) Get() *DeliveryAddressCreate {
	return v.value
}

func (v *NullableDeliveryAddressCreate) Set(val *DeliveryAddressCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableDeliveryAddressCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableDeliveryAddressCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeliveryAddressCreate(val *DeliveryAddressCreate) *NullableDeliveryAddressCreate {
	return &NullableDeliveryAddressCreate{value: val, isSet: true}
}

func (v NullableDeliveryAddressCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeliveryAddressCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
