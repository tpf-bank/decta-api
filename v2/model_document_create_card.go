...
// checks if the DocumentCreateCard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentCreateCard{}

// DocumentCreateCard Cardholder identification document
type DocumentCreateCard struct {
	// Type of ID document of a person
	Type *string `json:"type,omitempty"`
	// Subtype of ID document of a person.
	Subtype *string `json:"subtype,omitempty"`
	// Number of ID document
	Number *string `json:"number,omitempty"`
	// Date(YYYY-MM-DD) of issue of person ID document
	IssuingDate *string `json:"issuingDate,omitempty"`
	// Date(YYYY-MM-DD) of birth of a person
...
func (o DocumentCreateCard) MarshalJSON() ([]byte, error) {
...
func (o DocumentCreateCard) ToMap() (map[string]interface{}, error) {
...
type NullableDocumentCreateCard struct {
	value *DocumentCreateCard
	isSet bool
}

func (v NullableDocumentCreateCard) Get() *DocumentCreateCard {
	return v.value
}

func (v *NullableDocumentCreateCard) Set(val *DocumentCreateCard) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentCreateCard) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentCreateCard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentCreateCard(val *DocumentCreateCard) *NullableDocumentCreateCard {
	return &NullableDocumentCreateCard{value: val, isSet: true}
}

func (v NullableDocumentCreateCard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentCreateCard) UnmarshalJSON(src []byte) error {
	v.isSet = true
