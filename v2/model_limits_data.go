...
// checks if the LimitsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LimitsData{}

// LimitsData Limits data
...
func (o LimitsData) MarshalJSON() ([]byte, error) {
...
func (o LimitsData) ToMap() (map[string]interface{}, error) {
...
func (o *LimitsData) UnmarshalJSON(data []byte) (err error) {
	...
	varLimitsData := _LimitsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLimitsData)

	if err != nil {
		return err
	}

	*o = LimitsData(varLimitsData)

	return err
}

type NullableLimitsData struct {
	value *LimitsData
	isSet bool
}

func (v NullableLimitsData) Get() *LimitsData {
	return v.value
}

func (v *NullableLimitsData) Set(val *LimitsData) {
	v.value = val
	v.isSet = true
}

func (v NullableLimitsData) IsSet() bool {
	return v.isSet
}

func (v *NullableLimitsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLimitsData(val *LimitsData) *NullableLimitsData {
	return &NullableLimitsData{value: val, isSet: true}
}

func (v NullableLimitsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLimitsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
