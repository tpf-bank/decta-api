...
// checks if the PinTryReset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PinTryReset{}

// PinTryReset PIN try reset parameters
type PinTryReset struct {
	// Card expiry date
	Expiry string `json:"expiry"`
	// Reason for resetting a card PIN counter
	Details *string `json:"details,omitempty"`
}

type _PinTryReset PinTryReset

// NewPinTryReset instantiates a new PinTryReset object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPinTryReset(expiry string) *PinTryReset {
	this := PinTryReset{}
	this.Expiry = expiry
	return &this
}
...
func (o PinTryReset) MarshalJSON() ([]byte, error) {
...
func (o PinTryReset) ToMap() (map[string]interface{}, error) {
...
func (o *PinTryReset) UnmarshalJSON(data []byte) (err error) {
	...
	varPinTryReset := _PinTryReset{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPinTryReset)

	if err != nil {
		return err
	}

	*o = PinTryReset(varPinTryReset)

	return err
}

type NullablePinTryReset struct {
	value *PinTryReset
	isSet bool
}

func (v NullablePinTryReset) Get() *PinTryReset {
	return v.value
}

func (v *NullablePinTryReset) Set(val *PinTryReset) {
	v.value = val
	v.isSet = true
}

func (v NullablePinTryReset) IsSet() bool {
	return v.isSet
}

func (v *NullablePinTryReset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePinTryReset(val *PinTryReset) *NullablePinTryReset {
	return &NullablePinTryReset{value: val, isSet: true}
}

func (v NullablePinTryReset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePinTryReset) UnmarshalJSON(src []byte) error {
	v.isSet = true
