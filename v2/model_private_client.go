...
// checks if the PrivateClient type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrivateClient{}

// PrivateClient Provide requested information about private client
type PrivateClient struct {
	...
	CurrentAddress *RegistrationAddress `json:"currentAddress,omitempty"`
	...
	// Is this person classified as Politically exposed person
...
func (o *PrivateClient) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PrivateClient) HasDocument() bool {
	if o != nil && !IsNil(o.Document) {
		return true
	}
...
// SetCurrentAddress gets a reference to the given RegistrationAddress and assigns it to the CurrentAddress field.
...
// SetAdditionalContact gets a reference to the given Contact and assigns it to the AdditionalContact field.
...
func (o *PrivateClient) GetPep() string {
	if o == nil || IsNil(o.Pep) {
		var ret string
		return ret
	}
	return *o.Pep
...
// and a boolean to check if the value has been set.
func (o *PrivateClient) GetPepOk() (*string, bool) {
	if o == nil || IsNil(o.Pep) {
		return nil, false
	}
	return o.Pep, true
...
func (o *PrivateClient) HasPep() bool {
	if o != nil && !IsNil(o.Pep) {
		return true
	}
...
func (o PrivateClient) ToMap() (map[string]interface{}, error) {
...
type NullablePrivateClient struct {
	value *PrivateClient
	isSet bool
}

func (v NullablePrivateClient) Get() *PrivateClient {
	return v.value
}

func (v *NullablePrivateClient) Set(val *PrivateClient) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateClient) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateClient) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateClient(val *PrivateClient) *NullablePrivateClient {
	return &NullablePrivateClient{value: val, isSet: true}
}

func (v NullablePrivateClient) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateClient) UnmarshalJSON(src []byte) error {
	v.isSet = true
