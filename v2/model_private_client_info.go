...
// checks if the PrivateClientInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrivateClientInfo{}

// PrivateClientInfo Provide requested information about private client
type PrivateClientInfo struct {
	// Person name
...
func (o PrivateClientInfo) MarshalJSON() ([]byte, error) {
...
func (o PrivateClientInfo) ToMap() (map[string]interface{}, error) {
...
type NullablePrivateClientInfo struct {
	value *PrivateClientInfo
	isSet bool
}

func (v NullablePrivateClientInfo) Get() *PrivateClientInfo {
	return v.value
}

func (v *NullablePrivateClientInfo) Set(val *PrivateClientInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateClientInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateClientInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateClientInfo(val *PrivateClientInfo) *NullablePrivateClientInfo {
	return &NullablePrivateClientInfo{value: val, isSet: true}
}

func (v NullablePrivateClientInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateClientInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
