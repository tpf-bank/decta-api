...
// checks if the UpdateEmail403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateEmail403Response{}

// UpdateEmail403Response ApiErrorsV2
type UpdateEmail403Response struct {
	// Errors list
...
func (o UpdateEmail403Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateEmail403Response) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateEmail403Response struct {
	value *UpdateEmail403Response
	isSet bool
}

func (v NullableUpdateEmail403Response) Get() *UpdateEmail403Response {
	return v.value
}

func (v *NullableUpdateEmail403Response) Set(val *UpdateEmail403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateEmail403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateEmail403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateEmail403Response(val *UpdateEmail403Response) *NullableUpdateEmail403Response {
	return &NullableUpdateEmail403Response{value: val, isSet: true}
}

func (v NullableUpdateEmail403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateEmail403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
